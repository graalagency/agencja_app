...
export const TitleAuthorFindFirstSelectSchema: z.ZodType<Prisma.TitleAuthorSelect> = z.object({
...
export const TitleAuthorFindFirstSelectZodSchema = z.object({
    titleId: z.boolean().optional(),
    authorId: z.boolean().optional(),
    isMain: z.boolean().optional(),
    order: z.boolean().optional(),
...
export const TitleAuthorFindFirstSchema: z.ZodType<Prisma.TitleAuthorFindFirstArgs> = z.object({ select: TitleAuthorFindFirstSelectSchema.optional(), include: z.lazy(() => TitleAuthorIncludeObjectSchema.optional()), orderBy: z.union([TitleAuthorOrderByWithRelationInputObjectSchema, TitleAuthorOrderByWithRelationInputObjectSchema.array()]).optional(), where: TitleAuthorWhereInputObjectSchema.optional(), cursor: TitleAuthorWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TitleAuthorScalarFieldEnumSchema, TitleAuthorScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TitleAuthorFindFirstArgs>;

export const TitleAuthorFindFirstZodSchema = z.object({ select: TitleAuthorFindFirstSelectSchema.optional(), include: z.lazy(() => TitleAuthorIncludeObjectSchema.optional()), orderBy: z.union([TitleAuthorOrderByWithRelationInputObjectSchema, TitleAuthorOrderByWithRelationInputObjectSchema.array()]).optional(), where: TitleAuthorWhereInputObjectSchema.optional(), cursor: TitleAuthorWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TitleAuthorScalarFieldEnumSchema, TitleAuthorScalarFieldEnumSchema.array()]).optional() }).strict();