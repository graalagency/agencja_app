...
export const tblSubmEventsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.tblSubmEventsSelect> = z.object({
...
export const tblSubmEventsFindFirstOrThrowSelectZodSchema = z.object({
    SubmEventID: z.boolean().optional(),
    SubmID: z.boolean().optional(),
    EventCode: z.boolean().optional(),
    EventDate: z.boolean().optional(),
...
export const tblSubmEventsFindFirstOrThrowSchema: z.ZodType<Prisma.tblSubmEventsFindFirstOrThrowArgs> = z.object({ select: tblSubmEventsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tblSubmEventsIncludeObjectSchema.optional()), orderBy: z.union([tblSubmEventsOrderByWithRelationInputObjectSchema, tblSubmEventsOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblSubmEventsWhereInputObjectSchema.optional(), cursor: tblSubmEventsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblSubmEventsScalarFieldEnumSchema, TblSubmEventsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblSubmEventsFindFirstOrThrowArgs>;

export const tblSubmEventsFindFirstOrThrowZodSchema = z.object({ select: tblSubmEventsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tblSubmEventsIncludeObjectSchema.optional()), orderBy: z.union([tblSubmEventsOrderByWithRelationInputObjectSchema, tblSubmEventsOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblSubmEventsWhereInputObjectSchema.optional(), cursor: tblSubmEventsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblSubmEventsScalarFieldEnumSchema, TblSubmEventsScalarFieldEnumSchema.array()]).optional() }).strict();