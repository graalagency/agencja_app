...
export const ArTransactionFindFirstSelectSchema: z.ZodType<Prisma.ArTransactionSelect> = z.object({
...
export const ArTransactionFindFirstSelectZodSchema = z.object({
    TransactionID: z.boolean().optional(),
    DefaultDocRef: z.boolean().optional(),
    InvNr: z.boolean().optional(),
    TransactionDate: z.boolean().optional(),
...
export const ArTransactionFindFirstSchema: z.ZodType<Prisma.ArTransactionFindFirstArgs> = z.object({ select: ArTransactionFindFirstSelectSchema.optional(), include: z.lazy(() => ArTransactionIncludeObjectSchema.optional()), orderBy: z.union([ArTransactionOrderByWithRelationInputObjectSchema, ArTransactionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArTransactionWhereInputObjectSchema.optional(), cursor: ArTransactionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArTransactionScalarFieldEnumSchema, ArTransactionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ArTransactionFindFirstArgs>;

export const ArTransactionFindFirstZodSchema = z.object({ select: ArTransactionFindFirstSelectSchema.optional(), include: z.lazy(() => ArTransactionIncludeObjectSchema.optional()), orderBy: z.union([ArTransactionOrderByWithRelationInputObjectSchema, ArTransactionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArTransactionWhereInputObjectSchema.optional(), cursor: ArTransactionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArTransactionScalarFieldEnumSchema, ArTransactionScalarFieldEnumSchema.array()]).optional() }).strict();