...
export const tblAgreementsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.tblAgreementsSelect> = z.object({
...
export const tblAgreementsFindFirstOrThrowSelectZodSchema = z.object({
    AgrID: z.boolean().optional(),
    CustID: z.boolean().optional(),
    CountryID: z.boolean().optional(),
    LangAbbr: z.boolean().optional(),
