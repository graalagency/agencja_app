...
export const tblPersonLoginFindManySelectSchema: z.ZodType<Prisma.tblPersonLoginSelect> = z.object({
...
export const tblPersonLoginFindManySelectZodSchema = z.object({
    PersonID: z.boolean().optional(),
    Login: z.boolean().optional(),
    DateBegin: z.boolean().optional(),
    DateEnd: z.boolean().optional()
...
export const tblPersonLoginFindManySchema: z.ZodType<Prisma.tblPersonLoginFindManyArgs> = z.object({ select: tblPersonLoginFindManySelectSchema.optional(),  orderBy: z.union([tblPersonLoginOrderByWithRelationInputObjectSchema, tblPersonLoginOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblPersonLoginWhereInputObjectSchema.optional(), cursor: tblPersonLoginWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblPersonLoginScalarFieldEnumSchema, TblPersonLoginScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblPersonLoginFindManyArgs>;

export const tblPersonLoginFindManyZodSchema = z.object({ select: tblPersonLoginFindManySelectSchema.optional(),  orderBy: z.union([tblPersonLoginOrderByWithRelationInputObjectSchema, tblPersonLoginOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblPersonLoginWhereInputObjectSchema.optional(), cursor: tblPersonLoginWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblPersonLoginScalarFieldEnumSchema, TblPersonLoginScalarFieldEnumSchema.array()]).optional() }).strict();