...
export const TitleAuthorFindManySelectSchema: z.ZodType<Prisma.TitleAuthorSelect> = z.object({
...
export const TitleAuthorFindManySelectZodSchema = z.object({
    titleId: z.boolean().optional(),
    authorId: z.boolean().optional(),
    isMain: z.boolean().optional(),
    order: z.boolean().optional(),
...
export const TitleAuthorFindManySchema: z.ZodType<Prisma.TitleAuthorFindManyArgs> = z.object({ select: TitleAuthorFindManySelectSchema.optional(), include: z.lazy(() => TitleAuthorIncludeObjectSchema.optional()), orderBy: z.union([TitleAuthorOrderByWithRelationInputObjectSchema, TitleAuthorOrderByWithRelationInputObjectSchema.array()]).optional(), where: TitleAuthorWhereInputObjectSchema.optional(), cursor: TitleAuthorWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TitleAuthorScalarFieldEnumSchema, TitleAuthorScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TitleAuthorFindManyArgs>;

export const TitleAuthorFindManyZodSchema = z.object({ select: TitleAuthorFindManySelectSchema.optional(), include: z.lazy(() => TitleAuthorIncludeObjectSchema.optional()), orderBy: z.union([TitleAuthorOrderByWithRelationInputObjectSchema, TitleAuthorOrderByWithRelationInputObjectSchema.array()]).optional(), where: TitleAuthorWhereInputObjectSchema.optional(), cursor: TitleAuthorWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TitleAuthorScalarFieldEnumSchema, TitleAuthorScalarFieldEnumSchema.array()]).optional() }).strict();