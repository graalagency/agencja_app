...
export const AgreementAdvanceFindManySelectSchema: z.ZodType<Prisma.AgreementAdvanceSelect> = z.object({
...
export const AgreementAdvanceFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    sourceId: z.boolean().optional(),
    agreementId: z.boolean().optional(),
    instalment: z.boolean().optional(),
...
export const AgreementAdvanceFindManySchema: z.ZodType<Prisma.AgreementAdvanceFindManyArgs> = z.object({ select: AgreementAdvanceFindManySelectSchema.optional(), include: z.lazy(() => AgreementAdvanceIncludeObjectSchema.optional()), orderBy: z.union([AgreementAdvanceOrderByWithRelationInputObjectSchema, AgreementAdvanceOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgreementAdvanceWhereInputObjectSchema.optional(), cursor: AgreementAdvanceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgreementAdvanceScalarFieldEnumSchema, AgreementAdvanceScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AgreementAdvanceFindManyArgs>;

export const AgreementAdvanceFindManyZodSchema = z.object({ select: AgreementAdvanceFindManySelectSchema.optional(), include: z.lazy(() => AgreementAdvanceIncludeObjectSchema.optional()), orderBy: z.union([AgreementAdvanceOrderByWithRelationInputObjectSchema, AgreementAdvanceOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgreementAdvanceWhereInputObjectSchema.optional(), cursor: AgreementAdvanceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgreementAdvanceScalarFieldEnumSchema, AgreementAdvanceScalarFieldEnumSchema.array()]).optional() }).strict();