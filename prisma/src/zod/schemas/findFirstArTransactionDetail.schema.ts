...
export const ArTransactionDetailFindFirstSelectSchema: z.ZodType<Prisma.ArTransactionDetailSelect> = z.object({
...
export const ArTransactionDetailFindFirstSelectZodSchema = z.object({
    ItemID: z.boolean().optional(),
    TransactionID: z.boolean().optional(),
    AccountID: z.boolean().optional(),
    Amount: z.boolean().optional(),
...
export const ArTransactionDetailFindFirstSchema: z.ZodType<Prisma.ArTransactionDetailFindFirstArgs> = z.object({ select: ArTransactionDetailFindFirstSelectSchema.optional(), include: z.lazy(() => ArTransactionDetailIncludeObjectSchema.optional()), orderBy: z.union([ArTransactionDetailOrderByWithRelationInputObjectSchema, ArTransactionDetailOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArTransactionDetailWhereInputObjectSchema.optional(), cursor: ArTransactionDetailWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArTransactionDetailScalarFieldEnumSchema, ArTransactionDetailScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ArTransactionDetailFindFirstArgs>;

export const ArTransactionDetailFindFirstZodSchema = z.object({ select: ArTransactionDetailFindFirstSelectSchema.optional(), include: z.lazy(() => ArTransactionDetailIncludeObjectSchema.optional()), orderBy: z.union([ArTransactionDetailOrderByWithRelationInputObjectSchema, ArTransactionDetailOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArTransactionDetailWhereInputObjectSchema.optional(), cursor: ArTransactionDetailWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArTransactionDetailScalarFieldEnumSchema, ArTransactionDetailScalarFieldEnumSchema.array()]).optional() }).strict();