...
export const dictXRateExcelNamesFindFirstSelectSchema: z.ZodType<Prisma.dictXRateExcelNamesSelect> = z.object({
    CurrID: z.boolean().optional(),
    Name: z.boolean().optional()
  }).strict() as unknown as z.ZodType<Prisma.dictXRateExcelNamesSelect>;

export const dictXRateExcelNamesFindFirstSelectZodSchema = z.object({
    CurrID: z.boolean().optional(),
    Name: z.boolean().optional()
  }).strict();

export const dictXRateExcelNamesFindFirstSchema: z.ZodType<Prisma.dictXRateExcelNamesFindFirstArgs> = z.object({ select: dictXRateExcelNamesFindFirstSelectSchema.optional(),  orderBy: z.union([dictXRateExcelNamesOrderByWithRelationInputObjectSchema, dictXRateExcelNamesOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictXRateExcelNamesWhereInputObjectSchema.optional(), cursor: dictXRateExcelNamesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictXRateExcelNamesScalarFieldEnumSchema, DictXRateExcelNamesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.dictXRateExcelNamesFindFirstArgs>;

export const dictXRateExcelNamesFindFirstZodSchema = z.object({ select: dictXRateExcelNamesFindFirstSelectSchema.optional(),  orderBy: z.union([dictXRateExcelNamesOrderByWithRelationInputObjectSchema, dictXRateExcelNamesOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictXRateExcelNamesWhereInputObjectSchema.optional(), cursor: dictXRateExcelNamesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictXRateExcelNamesScalarFieldEnumSchema, DictXRateExcelNamesScalarFieldEnumSchema.array()]).optional() }).strict();