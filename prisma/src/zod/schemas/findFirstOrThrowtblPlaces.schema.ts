...
export const tblPlacesFindFirstOrThrowSelectSchema: z.ZodType<Prisma.tblPlacesSelect> = z.object({
...
export const tblPlacesFindFirstOrThrowSelectZodSchema = z.object({
    PlaceID: z.boolean().optional(),
    PlaceDesc: z.boolean().optional(),
    tblUserAccess: z.boolean().optional(),
    _count: z.boolean().optional()
...
export const tblPlacesFindFirstOrThrowSchema: z.ZodType<Prisma.tblPlacesFindFirstOrThrowArgs> = z.object({ select: tblPlacesFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tblPlacesIncludeObjectSchema.optional()), orderBy: z.union([tblPlacesOrderByWithRelationInputObjectSchema, tblPlacesOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblPlacesWhereInputObjectSchema.optional(), cursor: tblPlacesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblPlacesScalarFieldEnumSchema, TblPlacesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblPlacesFindFirstOrThrowArgs>;

export const tblPlacesFindFirstOrThrowZodSchema = z.object({ select: tblPlacesFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tblPlacesIncludeObjectSchema.optional()), orderBy: z.union([tblPlacesOrderByWithRelationInputObjectSchema, tblPlacesOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblPlacesWhereInputObjectSchema.optional(), cursor: tblPlacesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblPlacesScalarFieldEnumSchema, TblPlacesScalarFieldEnumSchema.array()]).optional() }).strict();