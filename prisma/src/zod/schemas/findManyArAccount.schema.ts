...
export const ArAccountFindManySelectSchema: z.ZodType<Prisma.ArAccountSelect> = z.object({
    AccountID: z.boolean().optional(),
    AccountDescription: z.boolean().optional()
  }).strict() as unknown as z.ZodType<Prisma.ArAccountSelect>;

export const ArAccountFindManySelectZodSchema = z.object({
    AccountID: z.boolean().optional(),
    AccountDescription: z.boolean().optional()
  }).strict();

export const ArAccountFindManySchema: z.ZodType<Prisma.ArAccountFindManyArgs> = z.object({ select: ArAccountFindManySelectSchema.optional(),  orderBy: z.union([ArAccountOrderByWithRelationInputObjectSchema, ArAccountOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArAccountWhereInputObjectSchema.optional(), cursor: ArAccountWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArAccountScalarFieldEnumSchema, ArAccountScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ArAccountFindManyArgs>;

export const ArAccountFindManyZodSchema = z.object({ select: ArAccountFindManySelectSchema.optional(),  orderBy: z.union([ArAccountOrderByWithRelationInputObjectSchema, ArAccountOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArAccountWhereInputObjectSchema.optional(), cursor: ArAccountWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArAccountScalarFieldEnumSchema, ArAccountScalarFieldEnumSchema.array()]).optional() }).strict();