...
export const tblTitEventsFindManySelectSchema: z.ZodType<Prisma.tblTitEventsSelect> = z.object({
...
export const tblTitEventsFindManySelectZodSchema = z.object({
    TitEventID: z.boolean().optional(),
    CopyTypeID: z.boolean().optional(),
    EventCode: z.boolean().optional(),
    TitleID: z.boolean().optional(),
...
export const tblTitEventsFindManySchema: z.ZodType<Prisma.tblTitEventsFindManyArgs> = z.object({ select: tblTitEventsFindManySelectSchema.optional(), include: z.lazy(() => tblTitEventsIncludeObjectSchema.optional()), orderBy: z.union([tblTitEventsOrderByWithRelationInputObjectSchema, tblTitEventsOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblTitEventsWhereInputObjectSchema.optional(), cursor: tblTitEventsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblTitEventsScalarFieldEnumSchema, TblTitEventsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblTitEventsFindManyArgs>;

export const tblTitEventsFindManyZodSchema = z.object({ select: tblTitEventsFindManySelectSchema.optional(), include: z.lazy(() => tblTitEventsIncludeObjectSchema.optional()), orderBy: z.union([tblTitEventsOrderByWithRelationInputObjectSchema, tblTitEventsOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblTitEventsWhereInputObjectSchema.optional(), cursor: tblTitEventsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblTitEventsScalarFieldEnumSchema, TblTitEventsScalarFieldEnumSchema.array()]).optional() }).strict();