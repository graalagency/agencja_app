...
export const PublisherContactFindFirstOrThrowSelectSchema: z.ZodType<Prisma.PublisherContactSelect> = z.object({
...
export const PublisherContactFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    contactId: z.boolean().optional(),
    publisherId: z.boolean().optional(),
    isDefault: z.boolean().optional(),
...
export const PublisherContactFindFirstOrThrowSchema: z.ZodType<Prisma.PublisherContactFindFirstOrThrowArgs> = z.object({ select: PublisherContactFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => PublisherContactIncludeObjectSchema.optional()), orderBy: z.union([PublisherContactOrderByWithRelationInputObjectSchema, PublisherContactOrderByWithRelationInputObjectSchema.array()]).optional(), where: PublisherContactWhereInputObjectSchema.optional(), cursor: PublisherContactWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PublisherContactScalarFieldEnumSchema, PublisherContactScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PublisherContactFindFirstOrThrowArgs>;

export const PublisherContactFindFirstOrThrowZodSchema = z.object({ select: PublisherContactFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => PublisherContactIncludeObjectSchema.optional()), orderBy: z.union([PublisherContactOrderByWithRelationInputObjectSchema, PublisherContactOrderByWithRelationInputObjectSchema.array()]).optional(), where: PublisherContactWhereInputObjectSchema.optional(), cursor: PublisherContactWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PublisherContactScalarFieldEnumSchema, PublisherContactScalarFieldEnumSchema.array()]).optional() }).strict();