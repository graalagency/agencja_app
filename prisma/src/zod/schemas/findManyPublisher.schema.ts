...
export const PublisherFindManySchema: z.ZodType<Prisma.PublisherFindManyArgs> = z.object({ select: PublisherFindManySelectSchema.optional(), include: z.lazy(() => PublisherIncludeObjectSchema.optional()), orderBy: z.union([PublisherOrderByWithRelationInputObjectSchema, PublisherOrderByWithRelationInputObjectSchema.array()]).optional(), where: PublisherWhereInputObjectSchema.optional(), cursor: PublisherWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PublisherScalarFieldEnumSchema, PublisherScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PublisherFindManyArgs>;

export const PublisherFindManyZodSchema = z.object({ select: PublisherFindManySelectSchema.optional(), include: z.lazy(() => PublisherIncludeObjectSchema.optional()), orderBy: z.union([PublisherOrderByWithRelationInputObjectSchema, PublisherOrderByWithRelationInputObjectSchema.array()]).optional(), where: PublisherWhereInputObjectSchema.optional(), cursor: PublisherWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PublisherScalarFieldEnumSchema, PublisherScalarFieldEnumSchema.array()]).optional() }).strict();