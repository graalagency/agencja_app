...
export const ArTransferDetailFindManySelectSchema: z.ZodType<Prisma.ArTransferDetailSelect> = z.object({
...
export const ArTransferDetailFindManySelectZodSchema = z.object({
    TransferID: z.boolean().optional(),
    DebitID: z.boolean().optional(),
    AmtWired: z.boolean().optional(),
    Notes: z.boolean().optional(),
...
export const ArTransferDetailFindManySchema: z.ZodType<Prisma.ArTransferDetailFindManyArgs> = z.object({ select: ArTransferDetailFindManySelectSchema.optional(), include: z.lazy(() => ArTransferDetailIncludeObjectSchema.optional()), orderBy: z.union([ArTransferDetailOrderByWithRelationInputObjectSchema, ArTransferDetailOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArTransferDetailWhereInputObjectSchema.optional(), cursor: ArTransferDetailWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArTransferDetailScalarFieldEnumSchema, ArTransferDetailScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ArTransferDetailFindManyArgs>;

export const ArTransferDetailFindManyZodSchema = z.object({ select: ArTransferDetailFindManySelectSchema.optional(), include: z.lazy(() => ArTransferDetailIncludeObjectSchema.optional()), orderBy: z.union([ArTransferDetailOrderByWithRelationInputObjectSchema, ArTransferDetailOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArTransferDetailWhereInputObjectSchema.optional(), cursor: ArTransferDetailWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArTransferDetailScalarFieldEnumSchema, ArTransferDetailScalarFieldEnumSchema.array()]).optional() }).strict();