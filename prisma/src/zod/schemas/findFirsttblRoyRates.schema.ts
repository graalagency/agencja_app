...
export const tblRoyRatesFindFirstSelectSchema: z.ZodType<Prisma.tblRoyRatesSelect> = z.object({
...
export const tblRoyRatesFindFirstSelectZodSchema = z.object({
    Step: z.boolean().optional(),
    AgrRightID: z.boolean().optional(),
    AgrID: z.boolean().optional(),
    CpsMax: z.boolean().optional(),
...
export const tblRoyRatesFindFirstSchema: z.ZodType<Prisma.tblRoyRatesFindFirstArgs> = z.object({ select: tblRoyRatesFindFirstSelectSchema.optional(), include: z.lazy(() => tblRoyRatesIncludeObjectSchema.optional()), orderBy: z.union([tblRoyRatesOrderByWithRelationInputObjectSchema, tblRoyRatesOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblRoyRatesWhereInputObjectSchema.optional(), cursor: tblRoyRatesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblRoyRatesScalarFieldEnumSchema, TblRoyRatesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblRoyRatesFindFirstArgs>;

export const tblRoyRatesFindFirstZodSchema = z.object({ select: tblRoyRatesFindFirstSelectSchema.optional(), include: z.lazy(() => tblRoyRatesIncludeObjectSchema.optional()), orderBy: z.union([tblRoyRatesOrderByWithRelationInputObjectSchema, tblRoyRatesOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblRoyRatesWhereInputObjectSchema.optional(), cursor: tblRoyRatesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblRoyRatesScalarFieldEnumSchema, TblRoyRatesScalarFieldEnumSchema.array()]).optional() }).strict();