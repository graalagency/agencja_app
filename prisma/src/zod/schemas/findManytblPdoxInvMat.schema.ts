...
export const tblPdoxInvMatFindManySelectSchema: z.ZodType<Prisma.tblPdoxInvMatSelect> = z.object({
    Invoice_Nr: z.boolean().optional(),
    Title: z.boolean().optional(),
    ISBN: z.boolean().optional()
  }).strict() as unknown as z.ZodType<Prisma.tblPdoxInvMatSelect>;

export const tblPdoxInvMatFindManySelectZodSchema = z.object({
    Invoice_Nr: z.boolean().optional(),
    Title: z.boolean().optional(),
    ISBN: z.boolean().optional()
  }).strict();

export const tblPdoxInvMatFindManySchema: z.ZodType<Prisma.tblPdoxInvMatFindManyArgs> = z.object({ select: tblPdoxInvMatFindManySelectSchema.optional(),  orderBy: z.union([tblPdoxInvMatOrderByWithRelationInputObjectSchema, tblPdoxInvMatOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblPdoxInvMatWhereInputObjectSchema.optional(), cursor: tblPdoxInvMatWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblPdoxInvMatScalarFieldEnumSchema, TblPdoxInvMatScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblPdoxInvMatFindManyArgs>;

export const tblPdoxInvMatFindManyZodSchema = z.object({ select: tblPdoxInvMatFindManySelectSchema.optional(),  orderBy: z.union([tblPdoxInvMatOrderByWithRelationInputObjectSchema, tblPdoxInvMatOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblPdoxInvMatWhereInputObjectSchema.optional(), cursor: tblPdoxInvMatWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblPdoxInvMatScalarFieldEnumSchema, TblPdoxInvMatScalarFieldEnumSchema.array()]).optional() }).strict();