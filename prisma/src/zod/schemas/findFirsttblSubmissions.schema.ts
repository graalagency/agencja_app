...
export const tblSubmissionsFindFirstSelectSchema: z.ZodType<Prisma.tblSubmissionsSelect> = z.object({
...
export const tblSubmissionsFindFirstSelectZodSchema = z.object({
    SubmID: z.boolean().optional(),
    CopyTypeID: z.boolean().optional(),
    SubmSentTypeID: z.boolean().optional(),
    TitleID: z.boolean().optional(),
