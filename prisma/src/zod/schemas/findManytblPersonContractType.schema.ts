...
export const tblPersonContractTypeFindManySelectSchema: z.ZodType<Prisma.tblPersonContractTypeSelect> = z.object({
    CTypeID: z.boolean().optional(),
    CTypeDescr: z.boolean().optional()
  }).strict() as unknown as z.ZodType<Prisma.tblPersonContractTypeSelect>;

export const tblPersonContractTypeFindManySelectZodSchema = z.object({
    CTypeID: z.boolean().optional(),
    CTypeDescr: z.boolean().optional()
  }).strict();

export const tblPersonContractTypeFindManySchema: z.ZodType<Prisma.tblPersonContractTypeFindManyArgs> = z.object({ select: tblPersonContractTypeFindManySelectSchema.optional(),  orderBy: z.union([tblPersonContractTypeOrderByWithRelationInputObjectSchema, tblPersonContractTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblPersonContractTypeWhereInputObjectSchema.optional(), cursor: tblPersonContractTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblPersonContractTypeScalarFieldEnumSchema, TblPersonContractTypeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblPersonContractTypeFindManyArgs>;

export const tblPersonContractTypeFindManyZodSchema = z.object({ select: tblPersonContractTypeFindManySelectSchema.optional(),  orderBy: z.union([tblPersonContractTypeOrderByWithRelationInputObjectSchema, tblPersonContractTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblPersonContractTypeWhereInputObjectSchema.optional(), cursor: tblPersonContractTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblPersonContractTypeScalarFieldEnumSchema, TblPersonContractTypeScalarFieldEnumSchema.array()]).optional() }).strict();