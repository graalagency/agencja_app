...
export const dictCountriesFindManySelectSchema: z.ZodType<Prisma.dictCountriesSelect> = z.object({
...
export const dictCountriesFindManySelectZodSchema = z.object({
    CountryID: z.boolean().optional(),
    CountryDesc: z.boolean().optional(),
    CountryPL: z.boolean().optional(),
    Tax: z.boolean().optional(),
...
export const dictCountriesFindManySchema: z.ZodType<Prisma.dictCountriesFindManyArgs> = z.object({ select: dictCountriesFindManySelectSchema.optional(),  orderBy: z.union([dictCountriesOrderByWithRelationInputObjectSchema, dictCountriesOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictCountriesWhereInputObjectSchema.optional(), cursor: dictCountriesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictCountriesScalarFieldEnumSchema, DictCountriesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.dictCountriesFindManyArgs>;

export const dictCountriesFindManyZodSchema = z.object({ select: dictCountriesFindManySelectSchema.optional(),  orderBy: z.union([dictCountriesOrderByWithRelationInputObjectSchema, dictCountriesOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictCountriesWhereInputObjectSchema.optional(), cursor: dictCountriesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictCountriesScalarFieldEnumSchema, DictCountriesScalarFieldEnumSchema.array()]).optional() }).strict();