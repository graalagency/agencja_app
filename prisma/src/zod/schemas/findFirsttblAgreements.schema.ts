...
export const tblAgreementsFindFirstSelectSchema: z.ZodType<Prisma.tblAgreementsSelect> = z.object({
...
export const tblAgreementsFindFirstSelectZodSchema = z.object({
    AgrID: z.boolean().optional(),
    CustID: z.boolean().optional(),
    CountryID: z.boolean().optional(),
    LangAbbr: z.boolean().optional(),
...
export const tblAgreementsFindFirstSchema: z.ZodType<Prisma.tblAgreementsFindFirstArgs> = z.object({ select: tblAgreementsFindFirstSelectSchema.optional(), include: z.lazy(() => tblAgreementsIncludeObjectSchema.optional()), orderBy: z.union([tblAgreementsOrderByWithRelationInputObjectSchema, tblAgreementsOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblAgreementsWhereInputObjectSchema.optional(), cursor: tblAgreementsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblAgreementsScalarFieldEnumSchema, TblAgreementsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblAgreementsFindFirstArgs>;

export const tblAgreementsFindFirstZodSchema = z.object({ select: tblAgreementsFindFirstSelectSchema.optional(), include: z.lazy(() => tblAgreementsIncludeObjectSchema.optional()), orderBy: z.union([tblAgreementsOrderByWithRelationInputObjectSchema, tblAgreementsOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblAgreementsWhereInputObjectSchema.optional(), cursor: tblAgreementsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblAgreementsScalarFieldEnumSchema, TblAgreementsScalarFieldEnumSchema.array()]).optional() }).strict();