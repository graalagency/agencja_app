...
export const dictDistributionTypeFindUniqueSchema: z.ZodType<Prisma.dictDistributionTypeFindUniqueArgs> = z.object({ select: dictDistributionTypeSelectObjectSchema.optional(), include: dictDistributionTypeIncludeObjectSchema.optional(), where: dictDistributionTypeWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.dictDistributionTypeFindUniqueArgs>;

export const dictDistributionTypeFindUniqueZodSchema = z.object({ select: dictDistributionTypeSelectObjectSchema.optional(), include: dictDistributionTypeIncludeObjectSchema.optional(), where: dictDistributionTypeWhereUniqueInputObjectSchema }).strict();