...
export const pdxBilansFindFirstOrThrowSelectSchema: z.ZodType<Prisma.pdxBilansSelect> = z.object({
...
export const pdxBilansFindFirstOrThrowSelectZodSchema = z.object({
    Bil_nr: z.boolean().optional(),
    Waluta: z.boolean().optional(),
    Wyci_g: z.boolean().optional(),
    Data_wyc: z.boolean().optional(),
...
export const pdxBilansFindFirstOrThrowSchema: z.ZodType<Prisma.pdxBilansFindFirstOrThrowArgs> = z.object({ select: pdxBilansFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([pdxBilansOrderByWithRelationInputObjectSchema, pdxBilansOrderByWithRelationInputObjectSchema.array()]).optional(), where: pdxBilansWhereInputObjectSchema.optional(), cursor: pdxBilansWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PdxBilansScalarFieldEnumSchema, PdxBilansScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.pdxBilansFindFirstOrThrowArgs>;

export const pdxBilansFindFirstOrThrowZodSchema = z.object({ select: pdxBilansFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([pdxBilansOrderByWithRelationInputObjectSchema, pdxBilansOrderByWithRelationInputObjectSchema.array()]).optional(), where: pdxBilansWhereInputObjectSchema.optional(), cursor: pdxBilansWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PdxBilansScalarFieldEnumSchema, PdxBilansScalarFieldEnumSchema.array()]).optional() }).strict();