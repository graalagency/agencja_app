...
export const PearsonAdvAndRoyFindFirstOrThrowSelectSchema: z.ZodType<Prisma.PearsonAdvAndRoySelect> = z.object({
...
export const PearsonAdvAndRoyFindFirstOrThrowSelectZodSchema = z.object({
    ContractID: z.boolean().optional(),
    ISBN: z.boolean().optional(),
    ContractDate: z.boolean().optional(),
    PublisherName: z.boolean().optional(),
...
export const PearsonAdvAndRoyFindFirstOrThrowSchema: z.ZodType<Prisma.PearsonAdvAndRoyFindFirstOrThrowArgs> = z.object({ select: PearsonAdvAndRoyFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([PearsonAdvAndRoyOrderByWithRelationInputObjectSchema, PearsonAdvAndRoyOrderByWithRelationInputObjectSchema.array()]).optional(), where: PearsonAdvAndRoyWhereInputObjectSchema.optional(), cursor: PearsonAdvAndRoyWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PearsonAdvAndRoyScalarFieldEnumSchema, PearsonAdvAndRoyScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PearsonAdvAndRoyFindFirstOrThrowArgs>;

export const PearsonAdvAndRoyFindFirstOrThrowZodSchema = z.object({ select: PearsonAdvAndRoyFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([PearsonAdvAndRoyOrderByWithRelationInputObjectSchema, PearsonAdvAndRoyOrderByWithRelationInputObjectSchema.array()]).optional(), where: PearsonAdvAndRoyWhereInputObjectSchema.optional(), cursor: PearsonAdvAndRoyWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PearsonAdvAndRoyScalarFieldEnumSchema, PearsonAdvAndRoyScalarFieldEnumSchema.array()]).optional() }).strict();