...
export const dictMatTypeFindManySelectSchema: z.ZodType<Prisma.dictMatTypeSelect> = z.object({
...
export const dictMatTypeFindManySelectZodSchema = z.object({
    MatTypeID: z.boolean().optional(),
    MatTypeDesc: z.boolean().optional(),
    MatTypeDescPL: z.boolean().optional()
  }).strict();

export const dictMatTypeFindManySchema: z.ZodType<Prisma.dictMatTypeFindManyArgs> = z.object({ select: dictMatTypeFindManySelectSchema.optional(),  orderBy: z.union([dictMatTypeOrderByWithRelationInputObjectSchema, dictMatTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictMatTypeWhereInputObjectSchema.optional(), cursor: dictMatTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictMatTypeScalarFieldEnumSchema, DictMatTypeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.dictMatTypeFindManyArgs>;

export const dictMatTypeFindManyZodSchema = z.object({ select: dictMatTypeFindManySelectSchema.optional(),  orderBy: z.union([dictMatTypeOrderByWithRelationInputObjectSchema, dictMatTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictMatTypeWhereInputObjectSchema.optional(), cursor: dictMatTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictMatTypeScalarFieldEnumSchema, DictMatTypeScalarFieldEnumSchema.array()]).optional() }).strict();