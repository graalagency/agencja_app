...
export const tblInvoiceDetailsFindManySelectSchema: z.ZodType<Prisma.tblInvoiceDetailsSelect> = z.object({
...
export const tblInvoiceDetailsFindManySelectZodSchema = z.object({
    InvNum: z.boolean().optional(),
    InvDetKey: z.boolean().optional(),
    InvType: z.boolean().optional(),
    AgID: z.boolean().optional(),
...
export const tblInvoiceDetailsFindManySchema: z.ZodType<Prisma.tblInvoiceDetailsFindManyArgs> = z.object({ select: tblInvoiceDetailsFindManySelectSchema.optional(),  orderBy: z.union([tblInvoiceDetailsOrderByWithRelationInputObjectSchema, tblInvoiceDetailsOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblInvoiceDetailsWhereInputObjectSchema.optional(), cursor: tblInvoiceDetailsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblInvoiceDetailsScalarFieldEnumSchema, TblInvoiceDetailsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblInvoiceDetailsFindManyArgs>;

export const tblInvoiceDetailsFindManyZodSchema = z.object({ select: tblInvoiceDetailsFindManySelectSchema.optional(),  orderBy: z.union([tblInvoiceDetailsOrderByWithRelationInputObjectSchema, tblInvoiceDetailsOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblInvoiceDetailsWhereInputObjectSchema.optional(), cursor: tblInvoiceDetailsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblInvoiceDetailsScalarFieldEnumSchema, TblInvoiceDetailsScalarFieldEnumSchema.array()]).optional() }).strict();