...
export const dbo_LocalUserFindFirstSelectSchema: z.ZodType<Prisma.dbo_LocalUserSelect> = z.object({
...
export const dbo_LocalUserFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    email: z.boolean().optional(),
    passwordHash: z.boolean().optional(),
...
export const dbo_LocalUserFindFirstSchema: z.ZodType<Prisma.dbo_LocalUserFindFirstArgs> = z.object({ select: dbo_LocalUserFindFirstSelectSchema.optional(),  orderBy: z.union([dbo_LocalUserOrderByWithRelationInputObjectSchema, dbo_LocalUserOrderByWithRelationInputObjectSchema.array()]).optional(), where: dbo_LocalUserWhereInputObjectSchema.optional(), cursor: dbo_LocalUserWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DboLocalUserScalarFieldEnumSchema, DboLocalUserScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.dbo_LocalUserFindFirstArgs>;

export const dbo_LocalUserFindFirstZodSchema = z.object({ select: dbo_LocalUserFindFirstSelectSchema.optional(),  orderBy: z.union([dbo_LocalUserOrderByWithRelationInputObjectSchema, dbo_LocalUserOrderByWithRelationInputObjectSchema.array()]).optional(), where: dbo_LocalUserWhereInputObjectSchema.optional(), cursor: dbo_LocalUserWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DboLocalUserScalarFieldEnumSchema, DboLocalUserScalarFieldEnumSchema.array()]).optional() }).strict();