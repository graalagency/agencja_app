...
export const pdxTRANSFERFindManySelectSchema: z.ZodType<Prisma.pdxTRANSFERSelect> = z.object({
...
export const pdxTRANSFERFindManySelectZodSchema = z.object({
    Bil_nr: z.boolean().optional(),
    Date: z.boolean().optional(),
    PayType: z.boolean().optional(),
    Nasz_inv: z.boolean().optional(),
...
export const pdxTRANSFERFindManySchema: z.ZodType<Prisma.pdxTRANSFERFindManyArgs> = z.object({ select: pdxTRANSFERFindManySelectSchema.optional(),  orderBy: z.union([pdxTRANSFEROrderByWithRelationInputObjectSchema, pdxTRANSFEROrderByWithRelationInputObjectSchema.array()]).optional(), where: pdxTRANSFERWhereInputObjectSchema.optional(), cursor: pdxTRANSFERWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PdxTRANSFERScalarFieldEnumSchema, PdxTRANSFERScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.pdxTRANSFERFindManyArgs>;

export const pdxTRANSFERFindManyZodSchema = z.object({ select: pdxTRANSFERFindManySelectSchema.optional(),  orderBy: z.union([pdxTRANSFEROrderByWithRelationInputObjectSchema, pdxTRANSFEROrderByWithRelationInputObjectSchema.array()]).optional(), where: pdxTRANSFERWhereInputObjectSchema.optional(), cursor: pdxTRANSFERWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PdxTRANSFERScalarFieldEnumSchema, PdxTRANSFERScalarFieldEnumSchema.array()]).optional() }).strict();