...
export const tblInvoiceFindFirstSelectSchema: z.ZodType<Prisma.tblInvoiceSelect> = z.object({
...
export const tblInvoiceFindFirstSelectZodSchema = z.object({
    InvNum: z.boolean().optional(),
    InvType: z.boolean().optional(),
    InvDate: z.boolean().optional(),
    BillToId: z.boolean().optional(),
...
export const tblInvoiceFindFirstSchema: z.ZodType<Prisma.tblInvoiceFindFirstArgs> = z.object({ select: tblInvoiceFindFirstSelectSchema.optional(),  orderBy: z.union([tblInvoiceOrderByWithRelationInputObjectSchema, tblInvoiceOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblInvoiceWhereInputObjectSchema.optional(), cursor: tblInvoiceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblInvoiceScalarFieldEnumSchema, TblInvoiceScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblInvoiceFindFirstArgs>;

export const tblInvoiceFindFirstZodSchema = z.object({ select: tblInvoiceFindFirstSelectSchema.optional(),  orderBy: z.union([tblInvoiceOrderByWithRelationInputObjectSchema, tblInvoiceOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblInvoiceWhereInputObjectSchema.optional(), cursor: tblInvoiceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblInvoiceScalarFieldEnumSchema, TblInvoiceScalarFieldEnumSchema.array()]).optional() }).strict();