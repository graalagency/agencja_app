...
export const dictTargetGroupsFindManySelectSchema: z.ZodType<Prisma.dictTargetGroupsSelect> = z.object({
...
export const dictTargetGroupsFindManySelectZodSchema = z.object({
    TargetGroupID: z.boolean().optional(),
    TargetGroupDesc: z.boolean().optional()
  }).strict();

export const dictTargetGroupsFindManySchema: z.ZodType<Prisma.dictTargetGroupsFindManyArgs> = z.object({ select: dictTargetGroupsFindManySelectSchema.optional(),  orderBy: z.union([dictTargetGroupsOrderByWithRelationInputObjectSchema, dictTargetGroupsOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictTargetGroupsWhereInputObjectSchema.optional(), cursor: dictTargetGroupsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictTargetGroupsScalarFieldEnumSchema, DictTargetGroupsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.dictTargetGroupsFindManyArgs>;

export const dictTargetGroupsFindManyZodSchema = z.object({ select: dictTargetGroupsFindManySelectSchema.optional(),  orderBy: z.union([dictTargetGroupsOrderByWithRelationInputObjectSchema, dictTargetGroupsOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictTargetGroupsWhereInputObjectSchema.optional(), cursor: dictTargetGroupsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictTargetGroupsScalarFieldEnumSchema, DictTargetGroupsScalarFieldEnumSchema.array()]).optional() }).strict();