...
export const TaxResidenceSendFindFirstOrThrowSelectSchema: z.ZodType<Prisma.TaxResidenceSendSelect> = z.object({
...
export const TaxResidenceSendFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    certId: z.boolean().optional(),
    clientId: z.boolean().optional(),
    publisherId: z.boolean().optional(),
...
export const TaxResidenceSendFindFirstOrThrowSchema: z.ZodType<Prisma.TaxResidenceSendFindFirstOrThrowArgs> = z.object({ select: TaxResidenceSendFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => TaxResidenceSendIncludeObjectSchema.optional()), orderBy: z.union([TaxResidenceSendOrderByWithRelationInputObjectSchema, TaxResidenceSendOrderByWithRelationInputObjectSchema.array()]).optional(), where: TaxResidenceSendWhereInputObjectSchema.optional(), cursor: TaxResidenceSendWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TaxResidenceSendScalarFieldEnumSchema, TaxResidenceSendScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TaxResidenceSendFindFirstOrThrowArgs>;

export const TaxResidenceSendFindFirstOrThrowZodSchema = z.object({ select: TaxResidenceSendFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => TaxResidenceSendIncludeObjectSchema.optional()), orderBy: z.union([TaxResidenceSendOrderByWithRelationInputObjectSchema, TaxResidenceSendOrderByWithRelationInputObjectSchema.array()]).optional(), where: TaxResidenceSendWhereInputObjectSchema.optional(), cursor: TaxResidenceSendWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TaxResidenceSendScalarFieldEnumSchema, TaxResidenceSendScalarFieldEnumSchema.array()]).optional() }).strict();