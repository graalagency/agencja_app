...
export const ArTransferDetailFindUniqueOrThrowSchema: z.ZodType<Prisma.ArTransferDetailFindUniqueOrThrowArgs> = z.object({ select: ArTransferDetailSelectObjectSchema.optional(), include: ArTransferDetailIncludeObjectSchema.optional(), where: ArTransferDetailWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.ArTransferDetailFindUniqueOrThrowArgs>;

export const ArTransferDetailFindUniqueOrThrowZodSchema = z.object({ select: ArTransferDetailSelectObjectSchema.optional(), include: ArTransferDetailIncludeObjectSchema.optional(), where: ArTransferDetailWhereUniqueInputObjectSchema }).strict();