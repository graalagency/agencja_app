...
export const TitleFindFirstOrThrowSelectSchema: z.ZodType<Prisma.TitleSelect> = z.object({
...
export const TitleFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    sourceId: z.boolean().optional(),
    clientId: z.boolean().optional(),
    publisherId: z.boolean().optional(),
...
export const TitleFindFirstOrThrowSchema: z.ZodType<Prisma.TitleFindFirstOrThrowArgs> = z.object({ select: TitleFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => TitleIncludeObjectSchema.optional()), orderBy: z.union([TitleOrderByWithRelationInputObjectSchema, TitleOrderByWithRelationInputObjectSchema.array()]).optional(), where: TitleWhereInputObjectSchema.optional(), cursor: TitleWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TitleScalarFieldEnumSchema, TitleScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TitleFindFirstOrThrowArgs>;

export const TitleFindFirstOrThrowZodSchema = z.object({ select: TitleFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => TitleIncludeObjectSchema.optional()), orderBy: z.union([TitleOrderByWithRelationInputObjectSchema, TitleOrderByWithRelationInputObjectSchema.array()]).optional(), where: TitleWhereInputObjectSchema.optional(), cursor: TitleWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TitleScalarFieldEnumSchema, TitleScalarFieldEnumSchema.array()]).optional() }).strict();