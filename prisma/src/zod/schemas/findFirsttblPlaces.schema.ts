...
export const tblPlacesFindFirstSelectSchema: z.ZodType<Prisma.tblPlacesSelect> = z.object({
...
export const tblPlacesFindFirstSelectZodSchema = z.object({
    PlaceID: z.boolean().optional(),
    PlaceDesc: z.boolean().optional(),
    tblUserAccess: z.boolean().optional(),
    _count: z.boolean().optional()
...
export const tblPlacesFindFirstSchema: z.ZodType<Prisma.tblPlacesFindFirstArgs> = z.object({ select: tblPlacesFindFirstSelectSchema.optional(), include: z.lazy(() => tblPlacesIncludeObjectSchema.optional()), orderBy: z.union([tblPlacesOrderByWithRelationInputObjectSchema, tblPlacesOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblPlacesWhereInputObjectSchema.optional(), cursor: tblPlacesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblPlacesScalarFieldEnumSchema, TblPlacesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblPlacesFindFirstArgs>;

export const tblPlacesFindFirstZodSchema = z.object({ select: tblPlacesFindFirstSelectSchema.optional(), include: z.lazy(() => tblPlacesIncludeObjectSchema.optional()), orderBy: z.union([tblPlacesOrderByWithRelationInputObjectSchema, tblPlacesOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblPlacesWhereInputObjectSchema.optional(), cursor: tblPlacesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblPlacesScalarFieldEnumSchema, TblPlacesScalarFieldEnumSchema.array()]).optional() }).strict();