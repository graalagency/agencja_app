...
export const tblSubmissionsFindManySelectSchema: z.ZodType<Prisma.tblSubmissionsSelect> = z.object({
...
export const tblSubmissionsFindManySelectZodSchema = z.object({
    SubmID: z.boolean().optional(),
    CopyTypeID: z.boolean().optional(),
    SubmSentTypeID: z.boolean().optional(),
    TitleID: z.boolean().optional(),
