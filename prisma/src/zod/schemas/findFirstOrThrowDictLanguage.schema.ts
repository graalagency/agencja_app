...
export const DictLanguageFindFirstOrThrowSelectSchema: z.ZodType<Prisma.DictLanguageSelect> = z.object({
...
export const DictLanguageFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    code: z.boolean().optional(),
    description: z.boolean().optional(),
    createdAt: z.boolean().optional(),
...
export const DictLanguageFindFirstOrThrowSchema: z.ZodType<Prisma.DictLanguageFindFirstOrThrowArgs> = z.object({ select: DictLanguageFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([DictLanguageOrderByWithRelationInputObjectSchema, DictLanguageOrderByWithRelationInputObjectSchema.array()]).optional(), where: DictLanguageWhereInputObjectSchema.optional(), cursor: DictLanguageWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictLanguageScalarFieldEnumSchema, DictLanguageScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.DictLanguageFindFirstOrThrowArgs>;

export const DictLanguageFindFirstOrThrowZodSchema = z.object({ select: DictLanguageFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([DictLanguageOrderByWithRelationInputObjectSchema, DictLanguageOrderByWithRelationInputObjectSchema.array()]).optional(), where: DictLanguageWhereInputObjectSchema.optional(), cursor: DictLanguageWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictLanguageScalarFieldEnumSchema, DictLanguageScalarFieldEnumSchema.array()]).optional() }).strict();