...
export const tblCustBankFindManySelectSchema: z.ZodType<Prisma.tblCustBankSelect> = z.object({
...
export const tblCustBankFindManySelectZodSchema = z.object({
    CustID: z.boolean().optional(),
    BankName: z.boolean().optional(),
    BankAddress: z.boolean().optional(),
    AccountNo: z.boolean().optional(),
...
export const tblCustBankFindManySchema: z.ZodType<Prisma.tblCustBankFindManyArgs> = z.object({ select: tblCustBankFindManySelectSchema.optional(), include: z.lazy(() => tblCustBankIncludeObjectSchema.optional()), orderBy: z.union([tblCustBankOrderByWithRelationInputObjectSchema, tblCustBankOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblCustBankWhereInputObjectSchema.optional(), cursor: tblCustBankWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblCustBankScalarFieldEnumSchema, TblCustBankScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblCustBankFindManyArgs>;

export const tblCustBankFindManyZodSchema = z.object({ select: tblCustBankFindManySelectSchema.optional(), include: z.lazy(() => tblCustBankIncludeObjectSchema.optional()), orderBy: z.union([tblCustBankOrderByWithRelationInputObjectSchema, tblCustBankOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblCustBankWhereInputObjectSchema.optional(), cursor: tblCustBankWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblCustBankScalarFieldEnumSchema, TblCustBankScalarFieldEnumSchema.array()]).optional() }).strict();