...
export const dictTitMainClassFindFirstOrThrowSelectSchema: z.ZodType<Prisma.dictTitMainClassSelect> = z.object({
...
export const dictTitMainClassFindFirstOrThrowSelectZodSchema = z.object({
    ClassCode: z.boolean().optional(),
    ClassDesc: z.boolean().optional(),
    dictTitSubClass: z.boolean().optional(),
    tblMailingLists: z.boolean().optional(),
...
export const dictTitMainClassFindFirstOrThrowSchema: z.ZodType<Prisma.dictTitMainClassFindFirstOrThrowArgs> = z.object({ select: dictTitMainClassFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => dictTitMainClassIncludeObjectSchema.optional()), orderBy: z.union([dictTitMainClassOrderByWithRelationInputObjectSchema, dictTitMainClassOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictTitMainClassWhereInputObjectSchema.optional(), cursor: dictTitMainClassWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictTitMainClassScalarFieldEnumSchema, DictTitMainClassScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.dictTitMainClassFindFirstOrThrowArgs>;

export const dictTitMainClassFindFirstOrThrowZodSchema = z.object({ select: dictTitMainClassFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => dictTitMainClassIncludeObjectSchema.optional()), orderBy: z.union([dictTitMainClassOrderByWithRelationInputObjectSchema, dictTitMainClassOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictTitMainClassWhereInputObjectSchema.optional(), cursor: dictTitMainClassWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictTitMainClassScalarFieldEnumSchema, DictTitMainClassScalarFieldEnumSchema.array()]).optional() }).strict();