...
export const pdxBilansFindManySelectSchema: z.ZodType<Prisma.pdxBilansSelect> = z.object({
...
export const pdxBilansFindManySelectZodSchema = z.object({
    Bil_nr: z.boolean().optional(),
    Waluta: z.boolean().optional(),
    Wyci_g: z.boolean().optional(),
    Data_wyc: z.boolean().optional(),
...
export const pdxBilansFindManySchema: z.ZodType<Prisma.pdxBilansFindManyArgs> = z.object({ select: pdxBilansFindManySelectSchema.optional(),  orderBy: z.union([pdxBilansOrderByWithRelationInputObjectSchema, pdxBilansOrderByWithRelationInputObjectSchema.array()]).optional(), where: pdxBilansWhereInputObjectSchema.optional(), cursor: pdxBilansWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PdxBilansScalarFieldEnumSchema, PdxBilansScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.pdxBilansFindManyArgs>;

export const pdxBilansFindManyZodSchema = z.object({ select: pdxBilansFindManySelectSchema.optional(),  orderBy: z.union([pdxBilansOrderByWithRelationInputObjectSchema, pdxBilansOrderByWithRelationInputObjectSchema.array()]).optional(), where: pdxBilansWhereInputObjectSchema.optional(), cursor: pdxBilansWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PdxBilansScalarFieldEnumSchema, PdxBilansScalarFieldEnumSchema.array()]).optional() }).strict();