...
export const dictEventsFindFirstSelectSchema: z.ZodType<Prisma.dictEventsSelect> = z.object({
...
export const dictEventsFindFirstSelectZodSchema = z.object({
    EventCode: z.boolean().optional(),
    EventDesc: z.boolean().optional(),
    tblSubmEvents: z.boolean().optional(),
    tblTitEvents: z.boolean().optional(),
...
export const dictEventsFindFirstSchema: z.ZodType<Prisma.dictEventsFindFirstArgs> = z.object({ select: dictEventsFindFirstSelectSchema.optional(), include: z.lazy(() => dictEventsIncludeObjectSchema.optional()), orderBy: z.union([dictEventsOrderByWithRelationInputObjectSchema, dictEventsOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictEventsWhereInputObjectSchema.optional(), cursor: dictEventsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictEventsScalarFieldEnumSchema, DictEventsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.dictEventsFindFirstArgs>;

export const dictEventsFindFirstZodSchema = z.object({ select: dictEventsFindFirstSelectSchema.optional(), include: z.lazy(() => dictEventsIncludeObjectSchema.optional()), orderBy: z.union([dictEventsOrderByWithRelationInputObjectSchema, dictEventsOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictEventsWhereInputObjectSchema.optional(), cursor: dictEventsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictEventsScalarFieldEnumSchema, DictEventsScalarFieldEnumSchema.array()]).optional() }).strict();