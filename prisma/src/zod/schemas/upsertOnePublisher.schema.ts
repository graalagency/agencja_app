...
export const PublisherUpsertOneSchema: z.ZodType<Prisma.PublisherUpsertArgs> = z.object({ select: PublisherSelectObjectSchema.optional(), include: PublisherIncludeObjectSchema.optional(), where: PublisherWhereUniqueInputObjectSchema, create: z.union([ PublisherCreateInputObjectSchema, PublisherUncheckedCreateInputObjectSchema ]), update: z.union([ PublisherUpdateInputObjectSchema, PublisherUncheckedUpdateInputObjectSchema ]) }).strict() as unknown as z.ZodType<Prisma.PublisherUpsertArgs>;

export const PublisherUpsertOneZodSchema = z.object({ select: PublisherSelectObjectSchema.optional(), include: PublisherIncludeObjectSchema.optional(), where: PublisherWhereUniqueInputObjectSchema, create: z.union([ PublisherCreateInputObjectSchema, PublisherUncheckedCreateInputObjectSchema ]), update: z.union([ PublisherUpdateInputObjectSchema, PublisherUncheckedUpdateInputObjectSchema ]) }).strict();