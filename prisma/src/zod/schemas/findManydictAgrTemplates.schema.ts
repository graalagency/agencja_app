...
export const dictAgrTemplatesFindManySelectSchema: z.ZodType<Prisma.dictAgrTemplatesSelect> = z.object({
    Name: z.boolean().optional(),
    FileName: z.boolean().optional()
  }).strict() as unknown as z.ZodType<Prisma.dictAgrTemplatesSelect>;

export const dictAgrTemplatesFindManySelectZodSchema = z.object({
    Name: z.boolean().optional(),
    FileName: z.boolean().optional()
  }).strict();

export const dictAgrTemplatesFindManySchema: z.ZodType<Prisma.dictAgrTemplatesFindManyArgs> = z.object({ select: dictAgrTemplatesFindManySelectSchema.optional(),  orderBy: z.union([dictAgrTemplatesOrderByWithRelationInputObjectSchema, dictAgrTemplatesOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictAgrTemplatesWhereInputObjectSchema.optional(), cursor: dictAgrTemplatesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictAgrTemplatesScalarFieldEnumSchema, DictAgrTemplatesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.dictAgrTemplatesFindManyArgs>;

export const dictAgrTemplatesFindManyZodSchema = z.object({ select: dictAgrTemplatesFindManySelectSchema.optional(),  orderBy: z.union([dictAgrTemplatesOrderByWithRelationInputObjectSchema, dictAgrTemplatesOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictAgrTemplatesWhereInputObjectSchema.optional(), cursor: dictAgrTemplatesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictAgrTemplatesScalarFieldEnumSchema, DictAgrTemplatesScalarFieldEnumSchema.array()]).optional() }).strict();