...
export const tblAdvanceFindFirstOrThrowSelectSchema: z.ZodType<Prisma.tblAdvanceSelect> = z.object({
...
export const tblAdvanceFindFirstOrThrowSelectZodSchema = z.object({
    AdvID: z.boolean().optional(),
    Inst: z.boolean().optional(),
    AgrID: z.boolean().optional(),
    AdvTermId: z.boolean().optional(),
