...
export const CurrencyDictionaryFindFirstOrThrowSelectSchema: z.ZodType<Prisma.CurrencyDictionarySelect> = z.object({
...
export const CurrencyDictionaryFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    code: z.boolean().optional(),
    description: z.boolean().optional(),
    createdAt: z.boolean().optional(),
...
export const CurrencyDictionaryFindFirstOrThrowSchema: z.ZodType<Prisma.CurrencyDictionaryFindFirstOrThrowArgs> = z.object({ select: CurrencyDictionaryFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([CurrencyDictionaryOrderByWithRelationInputObjectSchema, CurrencyDictionaryOrderByWithRelationInputObjectSchema.array()]).optional(), where: CurrencyDictionaryWhereInputObjectSchema.optional(), cursor: CurrencyDictionaryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CurrencyDictionaryScalarFieldEnumSchema, CurrencyDictionaryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CurrencyDictionaryFindFirstOrThrowArgs>;

export const CurrencyDictionaryFindFirstOrThrowZodSchema = z.object({ select: CurrencyDictionaryFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([CurrencyDictionaryOrderByWithRelationInputObjectSchema, CurrencyDictionaryOrderByWithRelationInputObjectSchema.array()]).optional(), where: CurrencyDictionaryWhereInputObjectSchema.optional(), cursor: CurrencyDictionaryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CurrencyDictionaryScalarFieldEnumSchema, CurrencyDictionaryScalarFieldEnumSchema.array()]).optional() }).strict();