...
export const ArTransferDetailFindUniqueSchema: z.ZodType<Prisma.ArTransferDetailFindUniqueArgs> = z.object({ select: ArTransferDetailSelectObjectSchema.optional(), include: ArTransferDetailIncludeObjectSchema.optional(), where: ArTransferDetailWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.ArTransferDetailFindUniqueArgs>;

export const ArTransferDetailFindUniqueZodSchema = z.object({ select: ArTransferDetailSelectObjectSchema.optional(), include: ArTransferDetailIncludeObjectSchema.optional(), where: ArTransferDetailWhereUniqueInputObjectSchema }).strict();