...
export const tblTitEventsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.tblTitEventsSelect> = z.object({
...
export const tblTitEventsFindFirstOrThrowSelectZodSchema = z.object({
    TitEventID: z.boolean().optional(),
    CopyTypeID: z.boolean().optional(),
    EventCode: z.boolean().optional(),
    TitleID: z.boolean().optional(),
...
export const tblTitEventsFindFirstOrThrowSchema: z.ZodType<Prisma.tblTitEventsFindFirstOrThrowArgs> = z.object({ select: tblTitEventsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tblTitEventsIncludeObjectSchema.optional()), orderBy: z.union([tblTitEventsOrderByWithRelationInputObjectSchema, tblTitEventsOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblTitEventsWhereInputObjectSchema.optional(), cursor: tblTitEventsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblTitEventsScalarFieldEnumSchema, TblTitEventsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblTitEventsFindFirstOrThrowArgs>;

export const tblTitEventsFindFirstOrThrowZodSchema = z.object({ select: tblTitEventsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tblTitEventsIncludeObjectSchema.optional()), orderBy: z.union([tblTitEventsOrderByWithRelationInputObjectSchema, tblTitEventsOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblTitEventsWhereInputObjectSchema.optional(), cursor: tblTitEventsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblTitEventsScalarFieldEnumSchema, TblTitEventsScalarFieldEnumSchema.array()]).optional() }).strict();