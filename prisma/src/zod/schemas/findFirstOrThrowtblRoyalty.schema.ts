...
export const tblRoyaltyFindFirstOrThrowSelectSchema: z.ZodType<Prisma.tblRoyaltySelect> = z.object({
...
export const tblRoyaltyFindFirstOrThrowSelectZodSchema = z.object({
    RoyID: z.boolean().optional(),
    AgrID: z.boolean().optional(),
    AgrRightID: z.boolean().optional(),
    RoyNr: z.boolean().optional(),
...
export const tblRoyaltyFindFirstOrThrowSchema: z.ZodType<Prisma.tblRoyaltyFindFirstOrThrowArgs> = z.object({ select: tblRoyaltyFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tblRoyaltyIncludeObjectSchema.optional()), orderBy: z.union([tblRoyaltyOrderByWithRelationInputObjectSchema, tblRoyaltyOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblRoyaltyWhereInputObjectSchema.optional(), cursor: tblRoyaltyWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblRoyaltyScalarFieldEnumSchema, TblRoyaltyScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblRoyaltyFindFirstOrThrowArgs>;

export const tblRoyaltyFindFirstOrThrowZodSchema = z.object({ select: tblRoyaltyFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tblRoyaltyIncludeObjectSchema.optional()), orderBy: z.union([tblRoyaltyOrderByWithRelationInputObjectSchema, tblRoyaltyOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblRoyaltyWhereInputObjectSchema.optional(), cursor: tblRoyaltyWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblRoyaltyScalarFieldEnumSchema, TblRoyaltyScalarFieldEnumSchema.array()]).optional() }).strict();