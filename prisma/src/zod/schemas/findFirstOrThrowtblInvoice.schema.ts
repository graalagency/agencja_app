...
export const tblInvoiceFindFirstOrThrowSelectSchema: z.ZodType<Prisma.tblInvoiceSelect> = z.object({
...
export const tblInvoiceFindFirstOrThrowSelectZodSchema = z.object({
    InvNum: z.boolean().optional(),
    InvType: z.boolean().optional(),
    InvDate: z.boolean().optional(),
    BillToId: z.boolean().optional(),
...
export const tblInvoiceFindFirstOrThrowSchema: z.ZodType<Prisma.tblInvoiceFindFirstOrThrowArgs> = z.object({ select: tblInvoiceFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([tblInvoiceOrderByWithRelationInputObjectSchema, tblInvoiceOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblInvoiceWhereInputObjectSchema.optional(), cursor: tblInvoiceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblInvoiceScalarFieldEnumSchema, TblInvoiceScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblInvoiceFindFirstOrThrowArgs>;

export const tblInvoiceFindFirstOrThrowZodSchema = z.object({ select: tblInvoiceFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([tblInvoiceOrderByWithRelationInputObjectSchema, tblInvoiceOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblInvoiceWhereInputObjectSchema.optional(), cursor: tblInvoiceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblInvoiceScalarFieldEnumSchema, TblInvoiceScalarFieldEnumSchema.array()]).optional() }).strict();