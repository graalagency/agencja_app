...
export const tblSeriesFindManySelectSchema: z.ZodType<Prisma.tblSeriesSelect> = z.object({
...
export const tblSeriesFindManySelectZodSchema = z.object({
    SeriesID: z.boolean().optional(),
    CustID: z.boolean().optional(),
    SeriesFullName: z.boolean().optional(),
    SeriesShortName: z.boolean().optional(),
...
export const tblSeriesFindManySchema: z.ZodType<Prisma.tblSeriesFindManyArgs> = z.object({ select: tblSeriesFindManySelectSchema.optional(), include: z.lazy(() => tblSeriesIncludeObjectSchema.optional()), orderBy: z.union([tblSeriesOrderByWithRelationInputObjectSchema, tblSeriesOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblSeriesWhereInputObjectSchema.optional(), cursor: tblSeriesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblSeriesScalarFieldEnumSchema, TblSeriesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblSeriesFindManyArgs>;

export const tblSeriesFindManyZodSchema = z.object({ select: tblSeriesFindManySelectSchema.optional(), include: z.lazy(() => tblSeriesIncludeObjectSchema.optional()), orderBy: z.union([tblSeriesOrderByWithRelationInputObjectSchema, tblSeriesOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblSeriesWhereInputObjectSchema.optional(), cursor: tblSeriesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblSeriesScalarFieldEnumSchema, TblSeriesScalarFieldEnumSchema.array()]).optional() }).strict();