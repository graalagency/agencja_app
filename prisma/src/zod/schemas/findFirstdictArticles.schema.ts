...
export const dictArticlesFindFirstSelectSchema: z.ZodType<Prisma.dictArticlesSelect> = z.object({
...
export const dictArticlesFindFirstSelectZodSchema = z.object({
    Article: z.boolean().optional(),
    LangAbb: z.boolean().optional(),
    dictLanguages: z.boolean().optional()
  }).strict();

export const dictArticlesFindFirstSchema: z.ZodType<Prisma.dictArticlesFindFirstArgs> = z.object({ select: dictArticlesFindFirstSelectSchema.optional(), include: z.lazy(() => dictArticlesIncludeObjectSchema.optional()), orderBy: z.union([dictArticlesOrderByWithRelationInputObjectSchema, dictArticlesOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictArticlesWhereInputObjectSchema.optional(), cursor: dictArticlesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictArticlesScalarFieldEnumSchema, DictArticlesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.dictArticlesFindFirstArgs>;

export const dictArticlesFindFirstZodSchema = z.object({ select: dictArticlesFindFirstSelectSchema.optional(), include: z.lazy(() => dictArticlesIncludeObjectSchema.optional()), orderBy: z.union([dictArticlesOrderByWithRelationInputObjectSchema, dictArticlesOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictArticlesWhereInputObjectSchema.optional(), cursor: dictArticlesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictArticlesScalarFieldEnumSchema, DictArticlesScalarFieldEnumSchema.array()]).optional() }).strict();