...
export const tblPubISBNFindFirstSelectSchema: z.ZodType<Prisma.tblPubISBNSelect> = z.object({
...
export const tblPubISBNFindFirstSelectZodSchema = z.object({
    PubID: z.boolean().optional(),
    PubISBN1: z.boolean().optional(),
    PubISBN2: z.boolean().optional(),
    tblPublishers: z.boolean().optional()
...
export const tblPubISBNFindFirstSchema: z.ZodType<Prisma.tblPubISBNFindFirstArgs> = z.object({ select: tblPubISBNFindFirstSelectSchema.optional(), include: z.lazy(() => tblPubISBNIncludeObjectSchema.optional()), orderBy: z.union([tblPubISBNOrderByWithRelationInputObjectSchema, tblPubISBNOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblPubISBNWhereInputObjectSchema.optional(), cursor: tblPubISBNWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblPubISBNScalarFieldEnumSchema, TblPubISBNScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblPubISBNFindFirstArgs>;

export const tblPubISBNFindFirstZodSchema = z.object({ select: tblPubISBNFindFirstSelectSchema.optional(), include: z.lazy(() => tblPubISBNIncludeObjectSchema.optional()), orderBy: z.union([tblPubISBNOrderByWithRelationInputObjectSchema, tblPubISBNOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblPubISBNWhereInputObjectSchema.optional(), cursor: tblPubISBNWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblPubISBNScalarFieldEnumSchema, TblPubISBNScalarFieldEnumSchema.array()]).optional() }).strict();