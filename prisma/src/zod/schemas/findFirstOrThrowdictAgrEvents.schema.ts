...
export const dictAgrEventsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.dictAgrEventsSelect> = z.object({
...
export const dictAgrEventsFindFirstOrThrowSelectZodSchema = z.object({
    AgrEventCode: z.boolean().optional(),
    AgrEventDesc: z.boolean().optional(),
    Status: z.boolean().optional(),
    tblAgrEvents: z.boolean().optional(),
...
export const dictAgrEventsFindFirstOrThrowSchema: z.ZodType<Prisma.dictAgrEventsFindFirstOrThrowArgs> = z.object({ select: dictAgrEventsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => dictAgrEventsIncludeObjectSchema.optional()), orderBy: z.union([dictAgrEventsOrderByWithRelationInputObjectSchema, dictAgrEventsOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictAgrEventsWhereInputObjectSchema.optional(), cursor: dictAgrEventsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictAgrEventsScalarFieldEnumSchema, DictAgrEventsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.dictAgrEventsFindFirstOrThrowArgs>;

export const dictAgrEventsFindFirstOrThrowZodSchema = z.object({ select: dictAgrEventsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => dictAgrEventsIncludeObjectSchema.optional()), orderBy: z.union([dictAgrEventsOrderByWithRelationInputObjectSchema, dictAgrEventsOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictAgrEventsWhereInputObjectSchema.optional(), cursor: dictAgrEventsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictAgrEventsScalarFieldEnumSchema, DictAgrEventsScalarFieldEnumSchema.array()]).optional() }).strict();