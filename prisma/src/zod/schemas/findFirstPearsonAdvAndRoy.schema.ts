...
export const PearsonAdvAndRoyFindFirstSelectSchema: z.ZodType<Prisma.PearsonAdvAndRoySelect> = z.object({
...
export const PearsonAdvAndRoyFindFirstSelectZodSchema = z.object({
    ContractID: z.boolean().optional(),
    ISBN: z.boolean().optional(),
    ContractDate: z.boolean().optional(),
    PublisherName: z.boolean().optional(),
...
export const PearsonAdvAndRoyFindFirstSchema: z.ZodType<Prisma.PearsonAdvAndRoyFindFirstArgs> = z.object({ select: PearsonAdvAndRoyFindFirstSelectSchema.optional(),  orderBy: z.union([PearsonAdvAndRoyOrderByWithRelationInputObjectSchema, PearsonAdvAndRoyOrderByWithRelationInputObjectSchema.array()]).optional(), where: PearsonAdvAndRoyWhereInputObjectSchema.optional(), cursor: PearsonAdvAndRoyWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PearsonAdvAndRoyScalarFieldEnumSchema, PearsonAdvAndRoyScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PearsonAdvAndRoyFindFirstArgs>;

export const PearsonAdvAndRoyFindFirstZodSchema = z.object({ select: PearsonAdvAndRoyFindFirstSelectSchema.optional(),  orderBy: z.union([PearsonAdvAndRoyOrderByWithRelationInputObjectSchema, PearsonAdvAndRoyOrderByWithRelationInputObjectSchema.array()]).optional(), where: PearsonAdvAndRoyWhereInputObjectSchema.optional(), cursor: PearsonAdvAndRoyWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PearsonAdvAndRoyScalarFieldEnumSchema, PearsonAdvAndRoyScalarFieldEnumSchema.array()]).optional() }).strict();