...
export const TaxResidenceCertFindManySelectSchema: z.ZodType<Prisma.TaxResidenceCertSelect> = z.object({
...
export const TaxResidenceCertFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    sourceId: z.boolean().optional(),
    clientId: z.boolean().optional(),
    publisherId: z.boolean().optional(),
...
export const TaxResidenceCertFindManySchema: z.ZodType<Prisma.TaxResidenceCertFindManyArgs> = z.object({ select: TaxResidenceCertFindManySelectSchema.optional(), include: z.lazy(() => TaxResidenceCertIncludeObjectSchema.optional()), orderBy: z.union([TaxResidenceCertOrderByWithRelationInputObjectSchema, TaxResidenceCertOrderByWithRelationInputObjectSchema.array()]).optional(), where: TaxResidenceCertWhereInputObjectSchema.optional(), cursor: TaxResidenceCertWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TaxResidenceCertScalarFieldEnumSchema, TaxResidenceCertScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TaxResidenceCertFindManyArgs>;

export const TaxResidenceCertFindManyZodSchema = z.object({ select: TaxResidenceCertFindManySelectSchema.optional(), include: z.lazy(() => TaxResidenceCertIncludeObjectSchema.optional()), orderBy: z.union([TaxResidenceCertOrderByWithRelationInputObjectSchema, TaxResidenceCertOrderByWithRelationInputObjectSchema.array()]).optional(), where: TaxResidenceCertWhereInputObjectSchema.optional(), cursor: TaxResidenceCertWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TaxResidenceCertScalarFieldEnumSchema, TaxResidenceCertScalarFieldEnumSchema.array()]).optional() }).strict();