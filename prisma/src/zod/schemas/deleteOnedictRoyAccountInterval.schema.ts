...
export const dictRoyAccountIntervalDeleteOneSchema: z.ZodType<Prisma.dictRoyAccountIntervalDeleteArgs> = z.object({ select: dictRoyAccountIntervalSelectObjectSchema.optional(), include: dictRoyAccountIntervalIncludeObjectSchema.optional(), where: dictRoyAccountIntervalWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.dictRoyAccountIntervalDeleteArgs>;

export const dictRoyAccountIntervalDeleteOneZodSchema = z.object({ select: dictRoyAccountIntervalSelectObjectSchema.optional(), include: dictRoyAccountIntervalIncludeObjectSchema.optional(), where: dictRoyAccountIntervalWhereUniqueInputObjectSchema }).strict();