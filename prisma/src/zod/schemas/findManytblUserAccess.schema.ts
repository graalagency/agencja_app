...
export const tblUserAccessFindManySelectSchema: z.ZodType<Prisma.tblUserAccessSelect> = z.object({
...
export const tblUserAccessFindManySelectZodSchema = z.object({
    Login: z.boolean().optional(),
    PlaceID: z.boolean().optional(),
    tblPlaces: z.boolean().optional(),
    tblUsers: z.boolean().optional()
