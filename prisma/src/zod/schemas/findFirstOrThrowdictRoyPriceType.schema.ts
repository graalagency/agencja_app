...
export const dictRoyPriceTypeFindFirstOrThrowSelectSchema: z.ZodType<Prisma.dictRoyPriceTypeSelect> = z.object({
...
export const dictRoyPriceTypeFindFirstOrThrowSelectZodSchema = z.object({
    RoyPriceTypeID: z.boolean().optional(),
    RoyPriceTypeDesc: z.boolean().optional(),
    RoyPriceTypePL: z.boolean().optional(),
    tblAgrRights: z.boolean().optional(),
...
export const dictRoyPriceTypeFindFirstOrThrowSchema: z.ZodType<Prisma.dictRoyPriceTypeFindFirstOrThrowArgs> = z.object({ select: dictRoyPriceTypeFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => dictRoyPriceTypeIncludeObjectSchema.optional()), orderBy: z.union([dictRoyPriceTypeOrderByWithRelationInputObjectSchema, dictRoyPriceTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictRoyPriceTypeWhereInputObjectSchema.optional(), cursor: dictRoyPriceTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictRoyPriceTypeScalarFieldEnumSchema, DictRoyPriceTypeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.dictRoyPriceTypeFindFirstOrThrowArgs>;

export const dictRoyPriceTypeFindFirstOrThrowZodSchema = z.object({ select: dictRoyPriceTypeFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => dictRoyPriceTypeIncludeObjectSchema.optional()), orderBy: z.union([dictRoyPriceTypeOrderByWithRelationInputObjectSchema, dictRoyPriceTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictRoyPriceTypeWhereInputObjectSchema.optional(), cursor: dictRoyPriceTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictRoyPriceTypeScalarFieldEnumSchema, DictRoyPriceTypeScalarFieldEnumSchema.array()]).optional() }).strict();