...
export const tblTitlesFindManySelectSchema: z.ZodType<Prisma.tblTitlesSelect> = z.object({
...
export const tblTitlesFindManySelectZodSchema = z.object({
    TitleID: z.boolean().optional(),
    CustID: z.boolean().optional(),
    PropID: z.boolean().optional(),
    Proprietor: z.boolean().optional(),
...
export const tblTitlesFindManySchema: z.ZodType<Prisma.tblTitlesFindManyArgs> = z.object({ select: tblTitlesFindManySelectSchema.optional(), include: z.lazy(() => tblTitlesIncludeObjectSchema.optional()), orderBy: z.union([tblTitlesOrderByWithRelationInputObjectSchema, tblTitlesOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblTitlesWhereInputObjectSchema.optional(), cursor: tblTitlesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblTitlesScalarFieldEnumSchema, TblTitlesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblTitlesFindManyArgs>;

export const tblTitlesFindManyZodSchema = z.object({ select: tblTitlesFindManySelectSchema.optional(), include: z.lazy(() => tblTitlesIncludeObjectSchema.optional()), orderBy: z.union([tblTitlesOrderByWithRelationInputObjectSchema, tblTitlesOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblTitlesWhereInputObjectSchema.optional(), cursor: tblTitlesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblTitlesScalarFieldEnumSchema, TblTitlesScalarFieldEnumSchema.array()]).optional() }).strict();