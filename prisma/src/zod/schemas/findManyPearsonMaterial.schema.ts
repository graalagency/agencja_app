...
export const PearsonMaterialFindManySelectSchema: z.ZodType<Prisma.PearsonMaterialSelect> = z.object({
...
export const PearsonMaterialFindManySelectZodSchema = z.object({
    MyNumber: z.boolean().optional(),
    ContractID: z.boolean().optional(),
    InvoiceNumber: z.boolean().optional(),
    InvoiceDate: z.boolean().optional(),
