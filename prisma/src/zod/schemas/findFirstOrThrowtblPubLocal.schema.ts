...
export const tblPubLocalFindFirstOrThrowSelectSchema: z.ZodType<Prisma.tblPubLocalSelect> = z.object({
...
export const tblPubLocalFindFirstOrThrowSelectZodSchema = z.object({
    PubLocalID: z.boolean().optional(),
    AgrID: z.boolean().optional(),
    LocalTitle: z.boolean().optional(),
    PubDate: z.boolean().optional(),
...
export const tblPubLocalFindFirstOrThrowSchema: z.ZodType<Prisma.tblPubLocalFindFirstOrThrowArgs> = z.object({ select: tblPubLocalFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tblPubLocalIncludeObjectSchema.optional()), orderBy: z.union([tblPubLocalOrderByWithRelationInputObjectSchema, tblPubLocalOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblPubLocalWhereInputObjectSchema.optional(), cursor: tblPubLocalWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblPubLocalScalarFieldEnumSchema, TblPubLocalScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblPubLocalFindFirstOrThrowArgs>;

export const tblPubLocalFindFirstOrThrowZodSchema = z.object({ select: tblPubLocalFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tblPubLocalIncludeObjectSchema.optional()), orderBy: z.union([tblPubLocalOrderByWithRelationInputObjectSchema, tblPubLocalOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblPubLocalWhereInputObjectSchema.optional(), cursor: tblPubLocalWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblPubLocalScalarFieldEnumSchema, TblPubLocalScalarFieldEnumSchema.array()]).optional() }).strict();