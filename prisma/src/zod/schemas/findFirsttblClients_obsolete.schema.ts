...
export const tblClients_obsoleteFindFirstSelectSchema: z.ZodType<Prisma.tblClients_obsoleteSelect> = z.object({
...
export const tblClients_obsoleteFindFirstSelectZodSchema = z.object({
    CustID: z.boolean().optional(),
    RepModeID: z.boolean().optional(),
    GraalID: z.boolean().optional(),
    Commission: z.boolean().optional(),
...
export const tblClients_obsoleteFindFirstSchema: z.ZodType<Prisma.tblClients_obsoleteFindFirstArgs> = z.object({ select: tblClients_obsoleteFindFirstSelectSchema.optional(), include: z.lazy(() => tblClients_obsoleteIncludeObjectSchema.optional()), orderBy: z.union([tblClients_obsoleteOrderByWithRelationInputObjectSchema, tblClients_obsoleteOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblClients_obsoleteWhereInputObjectSchema.optional(), cursor: tblClients_obsoleteWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblClientsObsoleteScalarFieldEnumSchema, TblClientsObsoleteScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblClients_obsoleteFindFirstArgs>;

export const tblClients_obsoleteFindFirstZodSchema = z.object({ select: tblClients_obsoleteFindFirstSelectSchema.optional(), include: z.lazy(() => tblClients_obsoleteIncludeObjectSchema.optional()), orderBy: z.union([tblClients_obsoleteOrderByWithRelationInputObjectSchema, tblClients_obsoleteOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblClients_obsoleteWhereInputObjectSchema.optional(), cursor: tblClients_obsoleteWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblClientsObsoleteScalarFieldEnumSchema, TblClientsObsoleteScalarFieldEnumSchema.array()]).optional() }).strict();