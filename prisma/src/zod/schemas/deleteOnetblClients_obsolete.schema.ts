...
export const tblClients_obsoleteDeleteOneSchema: z.ZodType<Prisma.tblClients_obsoleteDeleteArgs> = z.object({ select: tblClients_obsoleteSelectObjectSchema.optional(), include: tblClients_obsoleteIncludeObjectSchema.optional(), where: tblClients_obsoleteWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.tblClients_obsoleteDeleteArgs>;

export const tblClients_obsoleteDeleteOneZodSchema = z.object({ select: tblClients_obsoleteSelectObjectSchema.optional(), include: tblClients_obsoleteIncludeObjectSchema.optional(), where: tblClients_obsoleteWhereUniqueInputObjectSchema }).strict();