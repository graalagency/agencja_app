...
export const dictTitMainClassFindFirstSelectSchema: z.ZodType<Prisma.dictTitMainClassSelect> = z.object({
...
export const dictTitMainClassFindFirstSelectZodSchema = z.object({
    ClassCode: z.boolean().optional(),
    ClassDesc: z.boolean().optional(),
    dictTitSubClass: z.boolean().optional(),
    tblMailingLists: z.boolean().optional(),
...
export const dictTitMainClassFindFirstSchema: z.ZodType<Prisma.dictTitMainClassFindFirstArgs> = z.object({ select: dictTitMainClassFindFirstSelectSchema.optional(), include: z.lazy(() => dictTitMainClassIncludeObjectSchema.optional()), orderBy: z.union([dictTitMainClassOrderByWithRelationInputObjectSchema, dictTitMainClassOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictTitMainClassWhereInputObjectSchema.optional(), cursor: dictTitMainClassWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictTitMainClassScalarFieldEnumSchema, DictTitMainClassScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.dictTitMainClassFindFirstArgs>;

export const dictTitMainClassFindFirstZodSchema = z.object({ select: dictTitMainClassFindFirstSelectSchema.optional(), include: z.lazy(() => dictTitMainClassIncludeObjectSchema.optional()), orderBy: z.union([dictTitMainClassOrderByWithRelationInputObjectSchema, dictTitMainClassOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictTitMainClassWhereInputObjectSchema.optional(), cursor: dictTitMainClassWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictTitMainClassScalarFieldEnumSchema, DictTitMainClassScalarFieldEnumSchema.array()]).optional() }).strict();