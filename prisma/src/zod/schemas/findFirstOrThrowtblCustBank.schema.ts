...
export const tblCustBankFindFirstOrThrowSelectSchema: z.ZodType<Prisma.tblCustBankSelect> = z.object({
...
export const tblCustBankFindFirstOrThrowSelectZodSchema = z.object({
    CustID: z.boolean().optional(),
    BankName: z.boolean().optional(),
    BankAddress: z.boolean().optional(),
    AccountNo: z.boolean().optional(),
...
export const tblCustBankFindFirstOrThrowSchema: z.ZodType<Prisma.tblCustBankFindFirstOrThrowArgs> = z.object({ select: tblCustBankFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tblCustBankIncludeObjectSchema.optional()), orderBy: z.union([tblCustBankOrderByWithRelationInputObjectSchema, tblCustBankOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblCustBankWhereInputObjectSchema.optional(), cursor: tblCustBankWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblCustBankScalarFieldEnumSchema, TblCustBankScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblCustBankFindFirstOrThrowArgs>;

export const tblCustBankFindFirstOrThrowZodSchema = z.object({ select: tblCustBankFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tblCustBankIncludeObjectSchema.optional()), orderBy: z.union([tblCustBankOrderByWithRelationInputObjectSchema, tblCustBankOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblCustBankWhereInputObjectSchema.optional(), cursor: tblCustBankWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblCustBankScalarFieldEnumSchema, TblCustBankScalarFieldEnumSchema.array()]).optional() }).strict();