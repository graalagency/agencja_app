...
export const tblAgrRightsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.tblAgrRightsSelect> = z.object({
...
export const tblAgrRightsFindFirstOrThrowSelectZodSchema = z.object({
    AgrRightID: z.boolean().optional(),
    AgrID: z.boolean().optional(),
    RightID: z.boolean().optional(),
    PriceTypeID: z.boolean().optional(),
...
export const tblAgrRightsFindFirstOrThrowSchema: z.ZodType<Prisma.tblAgrRightsFindFirstOrThrowArgs> = z.object({ select: tblAgrRightsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tblAgrRightsIncludeObjectSchema.optional()), orderBy: z.union([tblAgrRightsOrderByWithRelationInputObjectSchema, tblAgrRightsOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblAgrRightsWhereInputObjectSchema.optional(), cursor: tblAgrRightsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblAgrRightsScalarFieldEnumSchema, TblAgrRightsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblAgrRightsFindFirstOrThrowArgs>;

export const tblAgrRightsFindFirstOrThrowZodSchema = z.object({ select: tblAgrRightsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tblAgrRightsIncludeObjectSchema.optional()), orderBy: z.union([tblAgrRightsOrderByWithRelationInputObjectSchema, tblAgrRightsOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblAgrRightsWhereInputObjectSchema.optional(), cursor: tblAgrRightsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblAgrRightsScalarFieldEnumSchema, TblAgrRightsScalarFieldEnumSchema.array()]).optional() }).strict();