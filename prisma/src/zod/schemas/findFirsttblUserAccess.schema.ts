...
export const tblUserAccessFindFirstSelectSchema: z.ZodType<Prisma.tblUserAccessSelect> = z.object({
...
export const tblUserAccessFindFirstSelectZodSchema = z.object({
    Login: z.boolean().optional(),
    PlaceID: z.boolean().optional(),
    tblPlaces: z.boolean().optional(),
    tblUsers: z.boolean().optional()
...
export const tblUserAccessFindFirstSchema: z.ZodType<Prisma.tblUserAccessFindFirstArgs> = z.object({ select: tblUserAccessFindFirstSelectSchema.optional(), include: z.lazy(() => tblUserAccessIncludeObjectSchema.optional()), orderBy: z.union([tblUserAccessOrderByWithRelationInputObjectSchema, tblUserAccessOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblUserAccessWhereInputObjectSchema.optional(), cursor: tblUserAccessWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblUserAccessScalarFieldEnumSchema, TblUserAccessScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblUserAccessFindFirstArgs>;

export const tblUserAccessFindFirstZodSchema = z.object({ select: tblUserAccessFindFirstSelectSchema.optional(), include: z.lazy(() => tblUserAccessIncludeObjectSchema.optional()), orderBy: z.union([tblUserAccessOrderByWithRelationInputObjectSchema, tblUserAccessOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblUserAccessWhereInputObjectSchema.optional(), cursor: tblUserAccessWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblUserAccessScalarFieldEnumSchema, TblUserAccessScalarFieldEnumSchema.array()]).optional() }).strict();