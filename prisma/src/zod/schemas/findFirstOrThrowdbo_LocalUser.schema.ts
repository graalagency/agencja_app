...
export const dbo_LocalUserFindFirstOrThrowSelectSchema: z.ZodType<Prisma.dbo_LocalUserSelect> = z.object({
...
export const dbo_LocalUserFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    email: z.boolean().optional(),
    passwordHash: z.boolean().optional(),
...
export const dbo_LocalUserFindFirstOrThrowSchema: z.ZodType<Prisma.dbo_LocalUserFindFirstOrThrowArgs> = z.object({ select: dbo_LocalUserFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([dbo_LocalUserOrderByWithRelationInputObjectSchema, dbo_LocalUserOrderByWithRelationInputObjectSchema.array()]).optional(), where: dbo_LocalUserWhereInputObjectSchema.optional(), cursor: dbo_LocalUserWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DboLocalUserScalarFieldEnumSchema, DboLocalUserScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.dbo_LocalUserFindFirstOrThrowArgs>;

export const dbo_LocalUserFindFirstOrThrowZodSchema = z.object({ select: dbo_LocalUserFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([dbo_LocalUserOrderByWithRelationInputObjectSchema, dbo_LocalUserOrderByWithRelationInputObjectSchema.array()]).optional(), where: dbo_LocalUserWhereInputObjectSchema.optional(), cursor: dbo_LocalUserWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DboLocalUserScalarFieldEnumSchema, DboLocalUserScalarFieldEnumSchema.array()]).optional() }).strict();