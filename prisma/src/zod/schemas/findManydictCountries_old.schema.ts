...
export const dictCountries_oldFindManySelectSchema: z.ZodType<Prisma.dictCountries_oldSelect> = z.object({
...
export const dictCountries_oldFindManySelectZodSchema = z.object({
    CountryID: z.boolean().optional(),
    CountryDesc: z.boolean().optional(),
    CountryPL: z.boolean().optional(),
    Tax: z.boolean().optional(),
...
export const dictCountries_oldFindManySchema: z.ZodType<Prisma.dictCountries_oldFindManyArgs> = z.object({ select: dictCountries_oldFindManySelectSchema.optional(), include: z.lazy(() => dictCountries_oldIncludeObjectSchema.optional()), orderBy: z.union([dictCountries_oldOrderByWithRelationInputObjectSchema, dictCountries_oldOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictCountries_oldWhereInputObjectSchema.optional(), cursor: dictCountries_oldWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictCountriesOldScalarFieldEnumSchema, DictCountriesOldScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.dictCountries_oldFindManyArgs>;

export const dictCountries_oldFindManyZodSchema = z.object({ select: dictCountries_oldFindManySelectSchema.optional(), include: z.lazy(() => dictCountries_oldIncludeObjectSchema.optional()), orderBy: z.union([dictCountries_oldOrderByWithRelationInputObjectSchema, dictCountries_oldOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictCountries_oldWhereInputObjectSchema.optional(), cursor: dictCountries_oldWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictCountriesOldScalarFieldEnumSchema, DictCountriesOldScalarFieldEnumSchema.array()]).optional() }).strict();