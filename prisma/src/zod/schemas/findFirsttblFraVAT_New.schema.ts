...
export const tblFraVAT_NewFindFirstSelectSchema: z.ZodType<Prisma.tblFraVAT_NewSelect> = z.object({
...
export const tblFraVAT_NewFindFirstSelectZodSchema = z.object({
    FVNr: z.boolean().optional(),
    FVDate: z.boolean().optional(),
    FVDateIssued: z.boolean().optional(),
    FVType: z.boolean().optional(),
...
export const tblFraVAT_NewFindFirstSchema: z.ZodType<Prisma.tblFraVAT_NewFindFirstArgs> = z.object({ select: tblFraVAT_NewFindFirstSelectSchema.optional(),  orderBy: z.union([tblFraVAT_NewOrderByWithRelationInputObjectSchema, tblFraVAT_NewOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblFraVAT_NewWhereInputObjectSchema.optional(), cursor: tblFraVAT_NewWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblFraVATNewScalarFieldEnumSchema, TblFraVATNewScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblFraVAT_NewFindFirstArgs>;

export const tblFraVAT_NewFindFirstZodSchema = z.object({ select: tblFraVAT_NewFindFirstSelectSchema.optional(),  orderBy: z.union([tblFraVAT_NewOrderByWithRelationInputObjectSchema, tblFraVAT_NewOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblFraVAT_NewWhereInputObjectSchema.optional(), cursor: tblFraVAT_NewWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblFraVATNewScalarFieldEnumSchema, TblFraVATNewScalarFieldEnumSchema.array()]).optional() }).strict();