...
export const ArVatFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ArVatSelect> = z.object({
...
export const ArVatFindFirstOrThrowSelectZodSchema = z.object({
    VatCode: z.boolean().optional(),
    Description: z.boolean().optional(),
    VatRate: z.boolean().optional(),
    DescriptionPL: z.boolean().optional()
...
export const ArVatFindFirstOrThrowSchema: z.ZodType<Prisma.ArVatFindFirstOrThrowArgs> = z.object({ select: ArVatFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([ArVatOrderByWithRelationInputObjectSchema, ArVatOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArVatWhereInputObjectSchema.optional(), cursor: ArVatWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArVatScalarFieldEnumSchema, ArVatScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ArVatFindFirstOrThrowArgs>;

export const ArVatFindFirstOrThrowZodSchema = z.object({ select: ArVatFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([ArVatOrderByWithRelationInputObjectSchema, ArVatOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArVatWhereInputObjectSchema.optional(), cursor: ArVatWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArVatScalarFieldEnumSchema, ArVatScalarFieldEnumSchema.array()]).optional() }).strict();