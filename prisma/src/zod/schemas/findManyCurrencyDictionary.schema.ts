...
export const CurrencyDictionaryFindManySelectSchema: z.ZodType<Prisma.CurrencyDictionarySelect> = z.object({
...
export const CurrencyDictionaryFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    code: z.boolean().optional(),
    description: z.boolean().optional(),
    createdAt: z.boolean().optional(),
...
export const CurrencyDictionaryFindManySchema: z.ZodType<Prisma.CurrencyDictionaryFindManyArgs> = z.object({ select: CurrencyDictionaryFindManySelectSchema.optional(),  orderBy: z.union([CurrencyDictionaryOrderByWithRelationInputObjectSchema, CurrencyDictionaryOrderByWithRelationInputObjectSchema.array()]).optional(), where: CurrencyDictionaryWhereInputObjectSchema.optional(), cursor: CurrencyDictionaryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CurrencyDictionaryScalarFieldEnumSchema, CurrencyDictionaryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CurrencyDictionaryFindManyArgs>;

export const CurrencyDictionaryFindManyZodSchema = z.object({ select: CurrencyDictionaryFindManySelectSchema.optional(),  orderBy: z.union([CurrencyDictionaryOrderByWithRelationInputObjectSchema, CurrencyDictionaryOrderByWithRelationInputObjectSchema.array()]).optional(), where: CurrencyDictionaryWhereInputObjectSchema.optional(), cursor: CurrencyDictionaryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CurrencyDictionaryScalarFieldEnumSchema, CurrencyDictionaryScalarFieldEnumSchema.array()]).optional() }).strict();