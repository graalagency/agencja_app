...
export const dictCopyTypeFindFirstOrThrowSelectSchema: z.ZodType<Prisma.dictCopyTypeSelect> = z.object({
...
export const dictCopyTypeFindFirstOrThrowSelectZodSchema = z.object({
    CopyTypeID: z.boolean().optional(),
    CopyType: z.boolean().optional(),
    tblSubmissions: z.boolean().optional(),
    tblTitEvents: z.boolean().optional(),
