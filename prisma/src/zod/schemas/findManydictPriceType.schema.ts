...
export const dictPriceTypeFindManySelectSchema: z.ZodType<Prisma.dictPriceTypeSelect> = z.object({
...
export const dictPriceTypeFindManySelectZodSchema = z.object({
    PriceTypeID: z.boolean().optional(),
    PriceTypeDesc: z.boolean().optional(),
    PriceTypePL: z.boolean().optional(),
    tblAgrRights: z.boolean().optional(),
...
export const dictPriceTypeFindManySchema: z.ZodType<Prisma.dictPriceTypeFindManyArgs> = z.object({ select: dictPriceTypeFindManySelectSchema.optional(), include: z.lazy(() => dictPriceTypeIncludeObjectSchema.optional()), orderBy: z.union([dictPriceTypeOrderByWithRelationInputObjectSchema, dictPriceTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictPriceTypeWhereInputObjectSchema.optional(), cursor: dictPriceTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictPriceTypeScalarFieldEnumSchema, DictPriceTypeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.dictPriceTypeFindManyArgs>;

export const dictPriceTypeFindManyZodSchema = z.object({ select: dictPriceTypeFindManySelectSchema.optional(), include: z.lazy(() => dictPriceTypeIncludeObjectSchema.optional()), orderBy: z.union([dictPriceTypeOrderByWithRelationInputObjectSchema, dictPriceTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictPriceTypeWhereInputObjectSchema.optional(), cursor: dictPriceTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictPriceTypeScalarFieldEnumSchema, DictPriceTypeScalarFieldEnumSchema.array()]).optional() }).strict();