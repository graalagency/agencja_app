...
export const dictCountries_oldFindFirstOrThrowSelectSchema: z.ZodType<Prisma.dictCountries_oldSelect> = z.object({
...
export const dictCountries_oldFindFirstOrThrowSelectZodSchema = z.object({
    CountryID: z.boolean().optional(),
    CountryDesc: z.boolean().optional(),
    CountryPL: z.boolean().optional(),
    Tax: z.boolean().optional(),
...
export const dictCountries_oldFindFirstOrThrowSchema: z.ZodType<Prisma.dictCountries_oldFindFirstOrThrowArgs> = z.object({ select: dictCountries_oldFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => dictCountries_oldIncludeObjectSchema.optional()), orderBy: z.union([dictCountries_oldOrderByWithRelationInputObjectSchema, dictCountries_oldOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictCountries_oldWhereInputObjectSchema.optional(), cursor: dictCountries_oldWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictCountriesOldScalarFieldEnumSchema, DictCountriesOldScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.dictCountries_oldFindFirstOrThrowArgs>;

export const dictCountries_oldFindFirstOrThrowZodSchema = z.object({ select: dictCountries_oldFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => dictCountries_oldIncludeObjectSchema.optional()), orderBy: z.union([dictCountries_oldOrderByWithRelationInputObjectSchema, dictCountries_oldOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictCountries_oldWhereInputObjectSchema.optional(), cursor: dictCountries_oldWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictCountriesOldScalarFieldEnumSchema, DictCountriesOldScalarFieldEnumSchema.array()]).optional() }).strict();