...
export const ArTransferDetailFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ArTransferDetailSelect> = z.object({
...
export const ArTransferDetailFindFirstOrThrowSelectZodSchema = z.object({
    TransferID: z.boolean().optional(),
    DebitID: z.boolean().optional(),
    AmtWired: z.boolean().optional(),
    Notes: z.boolean().optional(),
...
export const ArTransferDetailFindFirstOrThrowSchema: z.ZodType<Prisma.ArTransferDetailFindFirstOrThrowArgs> = z.object({ select: ArTransferDetailFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ArTransferDetailIncludeObjectSchema.optional()), orderBy: z.union([ArTransferDetailOrderByWithRelationInputObjectSchema, ArTransferDetailOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArTransferDetailWhereInputObjectSchema.optional(), cursor: ArTransferDetailWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArTransferDetailScalarFieldEnumSchema, ArTransferDetailScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ArTransferDetailFindFirstOrThrowArgs>;

export const ArTransferDetailFindFirstOrThrowZodSchema = z.object({ select: ArTransferDetailFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ArTransferDetailIncludeObjectSchema.optional()), orderBy: z.union([ArTransferDetailOrderByWithRelationInputObjectSchema, ArTransferDetailOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArTransferDetailWhereInputObjectSchema.optional(), cursor: ArTransferDetailWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArTransferDetailScalarFieldEnumSchema, ArTransferDetailScalarFieldEnumSchema.array()]).optional() }).strict();