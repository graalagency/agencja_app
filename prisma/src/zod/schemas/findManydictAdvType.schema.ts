...
export const dictAdvTypeFindManySelectSchema: z.ZodType<Prisma.dictAdvTypeSelect> = z.object({
...
export const dictAdvTypeFindManySelectZodSchema = z.object({
    AdvTypeId: z.boolean().optional(),
    AdvTypeDesc: z.boolean().optional(),
    AdvTypeDescPL: z.boolean().optional()
  }).strict();

export const dictAdvTypeFindManySchema: z.ZodType<Prisma.dictAdvTypeFindManyArgs> = z.object({ select: dictAdvTypeFindManySelectSchema.optional(),  orderBy: z.union([dictAdvTypeOrderByWithRelationInputObjectSchema, dictAdvTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictAdvTypeWhereInputObjectSchema.optional(), cursor: dictAdvTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictAdvTypeScalarFieldEnumSchema, DictAdvTypeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.dictAdvTypeFindManyArgs>;

export const dictAdvTypeFindManyZodSchema = z.object({ select: dictAdvTypeFindManySelectSchema.optional(),  orderBy: z.union([dictAdvTypeOrderByWithRelationInputObjectSchema, dictAdvTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictAdvTypeWhereInputObjectSchema.optional(), cursor: dictAdvTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictAdvTypeScalarFieldEnumSchema, DictAdvTypeScalarFieldEnumSchema.array()]).optional() }).strict();