...
export const AgreementRightFindManySelectSchema: z.ZodType<Prisma.AgreementRightSelect> = z.object({
...
export const AgreementRightFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    sourceId: z.boolean().optional(),
    agreementId: z.boolean().optional(),
    rightFormId: z.boolean().optional(),
...
export const AgreementRightFindManySchema: z.ZodType<Prisma.AgreementRightFindManyArgs> = z.object({ select: AgreementRightFindManySelectSchema.optional(), include: z.lazy(() => AgreementRightIncludeObjectSchema.optional()), orderBy: z.union([AgreementRightOrderByWithRelationInputObjectSchema, AgreementRightOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgreementRightWhereInputObjectSchema.optional(), cursor: AgreementRightWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgreementRightScalarFieldEnumSchema, AgreementRightScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AgreementRightFindManyArgs>;

export const AgreementRightFindManyZodSchema = z.object({ select: AgreementRightFindManySelectSchema.optional(), include: z.lazy(() => AgreementRightIncludeObjectSchema.optional()), orderBy: z.union([AgreementRightOrderByWithRelationInputObjectSchema, AgreementRightOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgreementRightWhereInputObjectSchema.optional(), cursor: AgreementRightWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgreementRightScalarFieldEnumSchema, AgreementRightScalarFieldEnumSchema.array()]).optional() }).strict();