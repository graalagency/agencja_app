...
export const tblAgrEventsFindFirstSelectSchema: z.ZodType<Prisma.tblAgrEventsSelect> = z.object({
...
export const tblAgrEventsFindFirstSelectZodSchema = z.object({
    AgrEventID: z.boolean().optional(),
    AgrID: z.boolean().optional(),
    AgrEventCode: z.boolean().optional(),
    EventDate: z.boolean().optional(),
...
export const tblAgrEventsFindFirstSchema: z.ZodType<Prisma.tblAgrEventsFindFirstArgs> = z.object({ select: tblAgrEventsFindFirstSelectSchema.optional(), include: z.lazy(() => tblAgrEventsIncludeObjectSchema.optional()), orderBy: z.union([tblAgrEventsOrderByWithRelationInputObjectSchema, tblAgrEventsOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblAgrEventsWhereInputObjectSchema.optional(), cursor: tblAgrEventsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblAgrEventsScalarFieldEnumSchema, TblAgrEventsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblAgrEventsFindFirstArgs>;

export const tblAgrEventsFindFirstZodSchema = z.object({ select: tblAgrEventsFindFirstSelectSchema.optional(), include: z.lazy(() => tblAgrEventsIncludeObjectSchema.optional()), orderBy: z.union([tblAgrEventsOrderByWithRelationInputObjectSchema, tblAgrEventsOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblAgrEventsWhereInputObjectSchema.optional(), cursor: tblAgrEventsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblAgrEventsScalarFieldEnumSchema, TblAgrEventsScalarFieldEnumSchema.array()]).optional() }).strict();