...
export const tblFraVAT_NewFindFirstOrThrowSelectSchema: z.ZodType<Prisma.tblFraVAT_NewSelect> = z.object({
...
export const tblFraVAT_NewFindFirstOrThrowSelectZodSchema = z.object({
    FVNr: z.boolean().optional(),
    FVDate: z.boolean().optional(),
    FVDateIssued: z.boolean().optional(),
    FVType: z.boolean().optional(),
...
export const tblFraVAT_NewFindFirstOrThrowSchema: z.ZodType<Prisma.tblFraVAT_NewFindFirstOrThrowArgs> = z.object({ select: tblFraVAT_NewFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([tblFraVAT_NewOrderByWithRelationInputObjectSchema, tblFraVAT_NewOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblFraVAT_NewWhereInputObjectSchema.optional(), cursor: tblFraVAT_NewWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblFraVATNewScalarFieldEnumSchema, TblFraVATNewScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblFraVAT_NewFindFirstOrThrowArgs>;

export const tblFraVAT_NewFindFirstOrThrowZodSchema = z.object({ select: tblFraVAT_NewFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([tblFraVAT_NewOrderByWithRelationInputObjectSchema, tblFraVAT_NewOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblFraVAT_NewWhereInputObjectSchema.optional(), cursor: tblFraVAT_NewWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblFraVATNewScalarFieldEnumSchema, TblFraVATNewScalarFieldEnumSchema.array()]).optional() }).strict();