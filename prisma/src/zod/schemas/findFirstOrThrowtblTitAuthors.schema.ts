...
export const tblTitAuthorsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.tblTitAuthorsSelect> = z.object({
...
export const tblTitAuthorsFindFirstOrThrowSelectZodSchema = z.object({
    AuthorID: z.boolean().optional(),
    TitleID: z.boolean().optional(),
    Main: z.boolean().optional(),
    Lp: z.boolean().optional(),
...
export const tblTitAuthorsFindFirstOrThrowSchema: z.ZodType<Prisma.tblTitAuthorsFindFirstOrThrowArgs> = z.object({ select: tblTitAuthorsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tblTitAuthorsIncludeObjectSchema.optional()), orderBy: z.union([tblTitAuthorsOrderByWithRelationInputObjectSchema, tblTitAuthorsOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblTitAuthorsWhereInputObjectSchema.optional(), cursor: tblTitAuthorsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblTitAuthorsScalarFieldEnumSchema, TblTitAuthorsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblTitAuthorsFindFirstOrThrowArgs>;

export const tblTitAuthorsFindFirstOrThrowZodSchema = z.object({ select: tblTitAuthorsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tblTitAuthorsIncludeObjectSchema.optional()), orderBy: z.union([tblTitAuthorsOrderByWithRelationInputObjectSchema, tblTitAuthorsOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblTitAuthorsWhereInputObjectSchema.optional(), cursor: tblTitAuthorsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblTitAuthorsScalarFieldEnumSchema, TblTitAuthorsScalarFieldEnumSchema.array()]).optional() }).strict();