...
export const DictCountryFindManySelectSchema: z.ZodType<Prisma.DictCountrySelect> = z.object({
...
export const DictCountryFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    description: z.boolean().optional(),
    code: z.boolean().optional(),
    tax: z.boolean().optional(),
...
export const DictCountryFindManySchema: z.ZodType<Prisma.DictCountryFindManyArgs> = z.object({ select: DictCountryFindManySelectSchema.optional(),  orderBy: z.union([DictCountryOrderByWithRelationInputObjectSchema, DictCountryOrderByWithRelationInputObjectSchema.array()]).optional(), where: DictCountryWhereInputObjectSchema.optional(), cursor: DictCountryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictCountryScalarFieldEnumSchema, DictCountryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.DictCountryFindManyArgs>;

export const DictCountryFindManyZodSchema = z.object({ select: DictCountryFindManySelectSchema.optional(),  orderBy: z.union([DictCountryOrderByWithRelationInputObjectSchema, DictCountryOrderByWithRelationInputObjectSchema.array()]).optional(), where: DictCountryWhereInputObjectSchema.optional(), cursor: DictCountryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictCountryScalarFieldEnumSchema, DictCountryScalarFieldEnumSchema.array()]).optional() }).strict();