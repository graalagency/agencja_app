...
export const tblTitlesFindFirstOrThrowSelectSchema: z.ZodType<Prisma.tblTitlesSelect> = z.object({
...
export const tblTitlesFindFirstOrThrowSelectZodSchema = z.object({
    TitleID: z.boolean().optional(),
    CustID: z.boolean().optional(),
    PropID: z.boolean().optional(),
    Proprietor: z.boolean().optional(),
...
export const tblTitlesFindFirstOrThrowSchema: z.ZodType<Prisma.tblTitlesFindFirstOrThrowArgs> = z.object({ select: tblTitlesFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tblTitlesIncludeObjectSchema.optional()), orderBy: z.union([tblTitlesOrderByWithRelationInputObjectSchema, tblTitlesOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblTitlesWhereInputObjectSchema.optional(), cursor: tblTitlesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblTitlesScalarFieldEnumSchema, TblTitlesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblTitlesFindFirstOrThrowArgs>;

export const tblTitlesFindFirstOrThrowZodSchema = z.object({ select: tblTitlesFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tblTitlesIncludeObjectSchema.optional()), orderBy: z.union([tblTitlesOrderByWithRelationInputObjectSchema, tblTitlesOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblTitlesWhereInputObjectSchema.optional(), cursor: tblTitlesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblTitlesScalarFieldEnumSchema, TblTitlesScalarFieldEnumSchema.array()]).optional() }).strict();