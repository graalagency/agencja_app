...
export const AgreementFindUniqueOrThrowSchema: z.ZodType<Prisma.AgreementFindUniqueOrThrowArgs> = z.object({ select: AgreementSelectObjectSchema.optional(), include: AgreementIncludeObjectSchema.optional(), where: AgreementWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.AgreementFindUniqueOrThrowArgs>;

export const AgreementFindUniqueOrThrowZodSchema = z.object({ select: AgreementSelectObjectSchema.optional(), include: AgreementIncludeObjectSchema.optional(), where: AgreementWhereUniqueInputObjectSchema }).strict();