...
export const tblTitAuxFindManySelectSchema: z.ZodType<Prisma.tblTitAuxSelect> = z.object({
...
export const tblTitAuxFindManySelectZodSchema = z.object({
    TitleID: z.boolean().optional(),
    CopyrightLine: z.boolean().optional(),
    tblTitles: z.boolean().optional()
  }).strict();

export const tblTitAuxFindManySchema: z.ZodType<Prisma.tblTitAuxFindManyArgs> = z.object({ select: tblTitAuxFindManySelectSchema.optional(), include: z.lazy(() => tblTitAuxIncludeObjectSchema.optional()), orderBy: z.union([tblTitAuxOrderByWithRelationInputObjectSchema, tblTitAuxOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblTitAuxWhereInputObjectSchema.optional(), cursor: tblTitAuxWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblTitAuxScalarFieldEnumSchema, TblTitAuxScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblTitAuxFindManyArgs>;

export const tblTitAuxFindManyZodSchema = z.object({ select: tblTitAuxFindManySelectSchema.optional(), include: z.lazy(() => tblTitAuxIncludeObjectSchema.optional()), orderBy: z.union([tblTitAuxOrderByWithRelationInputObjectSchema, tblTitAuxOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblTitAuxWhereInputObjectSchema.optional(), cursor: tblTitAuxWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblTitAuxScalarFieldEnumSchema, TblTitAuxScalarFieldEnumSchema.array()]).optional() }).strict();