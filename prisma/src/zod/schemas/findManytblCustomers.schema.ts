...
export const tblCustomersFindManySelectSchema: z.ZodType<Prisma.tblCustomersSelect> = z.object({
...
export const tblCustomersFindManySelectZodSchema = z.object({
    CustID: z.boolean().optional(),
    CustAbb: z.boolean().optional(),
    Account: z.boolean().optional(),
    CountryID: z.boolean().optional(),
...
export const tblCustomersFindManySchema: z.ZodType<Prisma.tblCustomersFindManyArgs> = z.object({ select: tblCustomersFindManySelectSchema.optional(), include: z.lazy(() => tblCustomersIncludeObjectSchema.optional()), orderBy: z.union([tblCustomersOrderByWithRelationInputObjectSchema, tblCustomersOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblCustomersWhereInputObjectSchema.optional(), cursor: tblCustomersWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblCustomersScalarFieldEnumSchema, TblCustomersScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblCustomersFindManyArgs>;

export const tblCustomersFindManyZodSchema = z.object({ select: tblCustomersFindManySelectSchema.optional(), include: z.lazy(() => tblCustomersIncludeObjectSchema.optional()), orderBy: z.union([tblCustomersOrderByWithRelationInputObjectSchema, tblCustomersOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblCustomersWhereInputObjectSchema.optional(), cursor: tblCustomersWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblCustomersScalarFieldEnumSchema, TblCustomersScalarFieldEnumSchema.array()]).optional() }).strict();