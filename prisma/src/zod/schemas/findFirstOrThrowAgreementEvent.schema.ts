...
export const AgreementEventFindFirstOrThrowSelectSchema: z.ZodType<Prisma.AgreementEventSelect> = z.object({
...
export const AgreementEventFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    sourceId: z.boolean().optional(),
    agreementId: z.boolean().optional(),
    eventCode: z.boolean().optional(),
...
export const AgreementEventFindFirstOrThrowSchema: z.ZodType<Prisma.AgreementEventFindFirstOrThrowArgs> = z.object({ select: AgreementEventFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => AgreementEventIncludeObjectSchema.optional()), orderBy: z.union([AgreementEventOrderByWithRelationInputObjectSchema, AgreementEventOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgreementEventWhereInputObjectSchema.optional(), cursor: AgreementEventWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgreementEventScalarFieldEnumSchema, AgreementEventScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AgreementEventFindFirstOrThrowArgs>;

export const AgreementEventFindFirstOrThrowZodSchema = z.object({ select: AgreementEventFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => AgreementEventIncludeObjectSchema.optional()), orderBy: z.union([AgreementEventOrderByWithRelationInputObjectSchema, AgreementEventOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgreementEventWhereInputObjectSchema.optional(), cursor: AgreementEventWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgreementEventScalarFieldEnumSchema, AgreementEventScalarFieldEnumSchema.array()]).optional() }).strict();