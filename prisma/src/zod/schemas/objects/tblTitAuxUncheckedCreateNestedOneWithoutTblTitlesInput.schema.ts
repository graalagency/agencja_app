...
export const tblTitAuxUncheckedCreateNestedOneWithoutTblTitlesInputObjectSchema: z.ZodType<Prisma.tblTitAuxUncheckedCreateNestedOneWithoutTblTitlesInput> = makeSchema() as unknown as z.ZodType<Prisma.tblTitAuxUncheckedCreateNestedOneWithoutTblTitlesInput>;
export const tblTitAuxUncheckedCreateNestedOneWithoutTblTitlesInputObjectZodSchema = makeSchema();
