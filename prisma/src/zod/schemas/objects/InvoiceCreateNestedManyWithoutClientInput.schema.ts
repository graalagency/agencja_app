...
export const InvoiceCreateNestedManyWithoutClientInputObjectSchema: z.ZodType<Prisma.InvoiceCreateNestedManyWithoutClientInput> = makeSchema() as unknown as z.ZodType<Prisma.InvoiceCreateNestedManyWithoutClientInput>;
export const InvoiceCreateNestedManyWithoutClientInputObjectZodSchema = makeSchema();
