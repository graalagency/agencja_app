...
export const TaxResidenceCertUncheckedCreateWithoutClientInputObjectSchema: z.ZodType<Prisma.TaxResidenceCertUncheckedCreateWithoutClientInput> = makeSchema() as unknown as z.ZodType<Prisma.TaxResidenceCertUncheckedCreateWithoutClientInput>;
export const TaxResidenceCertUncheckedCreateWithoutClientInputObjectZodSchema = makeSchema();
