...
import { tblSubmEventsUncheckedUpdateManyWithoutTblSubmissionsNestedInputObjectSchema as tblSubmEventsUncheckedUpdateManyWithoutTblSubmissionsNestedInputObjectSchema } from './tblSubmEventsUncheckedUpdateManyWithoutTblSubmissionsNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  TrackingNo: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  ...
  tblSubmEvents: z.lazy(() => tblSubmEventsUncheckedUpdateManyWithoutTblSubmissionsNestedInputObjectSchema).optional()
}).strict();
export const tblSubmissionsUncheckedUpdateWithoutDictSubmSentTypeInputObjectSchema: z.ZodType<Prisma.tblSubmissionsUncheckedUpdateWithoutDictSubmSentTypeInput> = makeSchema() as unknown as z.ZodType<Prisma.tblSubmissionsUncheckedUpdateWithoutDictSubmSentTypeInput>;
export const tblSubmissionsUncheckedUpdateWithoutDictSubmSentTypeInputObjectZodSchema = makeSchema();
