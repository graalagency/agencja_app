...
export const pdxBilansCreateInputObjectSchema: z.ZodType<Prisma.pdxBilansCreateInput> = makeSchema() as unknown as z.ZodType<Prisma.pdxBilansCreateInput>;
export const pdxBilansCreateInputObjectZodSchema = makeSchema();
