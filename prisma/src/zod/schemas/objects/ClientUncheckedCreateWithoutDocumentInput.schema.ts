...
import { ContactUncheckedCreateNestedManyWithoutClientInputObjectSchema as ContactUncheckedCreateNestedManyWithoutClientInputObjectSchema } from './ContactUncheckedCreateNestedManyWithoutClientInput.schema';
...
const makeSchema = () => z.object({
  ...
  Contact: z.lazy(() => ContactUncheckedCreateNestedManyWithoutClientInputObjectSchema).optional(),
  Invoice: z.lazy(() => InvoiceUncheckedCreateNestedManyWithoutClientInputObjectSchema).optional()
}).strict();
export const ClientUncheckedCreateWithoutDocumentInputObjectSchema: z.ZodType<Prisma.ClientUncheckedCreateWithoutDocumentInput> = makeSchema() as unknown as z.ZodType<Prisma.ClientUncheckedCreateWithoutDocumentInput>;
export const ClientUncheckedCreateWithoutDocumentInputObjectZodSchema = makeSchema();
