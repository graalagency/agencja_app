...
const makeSchema = () => z.object({
  ApplyID: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
  DebitID: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
  CreditID: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
...
export const ArApplyUncheckedUpdateManyInputObjectSchema: z.ZodType<Prisma.ArApplyUncheckedUpdateManyInput> = makeSchema() as unknown as z.ZodType<Prisma.ArApplyUncheckedUpdateManyInput>;
export const ArApplyUncheckedUpdateManyInputObjectZodSchema = makeSchema();
