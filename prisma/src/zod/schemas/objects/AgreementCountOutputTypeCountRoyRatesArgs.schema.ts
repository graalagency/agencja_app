...
export const AgreementCountOutputTypeCountRoyRatesArgsObjectSchema = makeSchema();
export const AgreementCountOutputTypeCountRoyRatesArgsObjectZodSchema = makeSchema();
