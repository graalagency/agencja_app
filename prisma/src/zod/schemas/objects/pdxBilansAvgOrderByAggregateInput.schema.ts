...
export const pdxBilansAvgOrderByAggregateInputObjectSchema: z.ZodType<Prisma.pdxBilansAvgOrderByAggregateInput> = makeSchema() as unknown as z.ZodType<Prisma.pdxBilansAvgOrderByAggregateInput>;
export const pdxBilansAvgOrderByAggregateInputObjectZodSchema = makeSchema();
