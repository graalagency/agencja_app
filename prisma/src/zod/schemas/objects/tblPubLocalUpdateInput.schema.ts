...
import { tblAgreementsUpdateOneWithoutTblPubLocalNestedInputObjectSchema as tblAgreementsUpdateOneWithoutTblPubLocalNestedInputObjectSchema } from './tblAgreementsUpdateOneWithoutTblPubLocalNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  tblAgreements: z.lazy(() => tblAgreementsUpdateOneWithoutTblPubLocalNestedInputObjectSchema).optional()
}).strict();
export const tblPubLocalUpdateInputObjectSchema: z.ZodType<Prisma.tblPubLocalUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.tblPubLocalUpdateInput>;
export const tblPubLocalUpdateInputObjectZodSchema = makeSchema();
