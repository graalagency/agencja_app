...
export const tblPersonMaxOrderByAggregateInputObjectSchema: z.ZodType<Prisma.tblPersonMaxOrderByAggregateInput> = makeSchema() as unknown as z.ZodType<Prisma.tblPersonMaxOrderByAggregateInput>;
export const tblPersonMaxOrderByAggregateInputObjectZodSchema = makeSchema();
