...
export const tblRoyaltyCountOrderByAggregateInputObjectSchema: z.ZodType<Prisma.tblRoyaltyCountOrderByAggregateInput> = makeSchema() as unknown as z.ZodType<Prisma.tblRoyaltyCountOrderByAggregateInput>;
export const tblRoyaltyCountOrderByAggregateInputObjectZodSchema = makeSchema();
