...
export const tblUsersMinOrderByAggregateInputObjectSchema: z.ZodType<Prisma.tblUsersMinOrderByAggregateInput> = makeSchema() as unknown as z.ZodType<Prisma.tblUsersMinOrderByAggregateInput>;
export const tblUsersMinOrderByAggregateInputObjectZodSchema = makeSchema();
