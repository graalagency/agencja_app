...
import { tblCustUsersUpdateManyWithoutTblUsersNestedInputObjectSchema as tblCustUsersUpdateManyWithoutTblUsersNestedInputObjectSchema } from './tblCustUsersUpdateManyWithoutTblUsersNestedInput.schema';
import { tblUserAccessUpdateManyWithoutTblUsersNestedInputObjectSchema as tblUserAccessUpdateManyWithoutTblUsersNestedInputObjectSchema } from './tblUserAccessUpdateManyWithoutTblUsersNestedInput.schema';
import { tblUserParamsUpdateManyWithoutTblUsersNestedInputObjectSchema as tblUserParamsUpdateManyWithoutTblUsersNestedInputObjectSchema } from './tblUserParamsUpdateManyWithoutTblUsersNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  tblCustUsers: z.lazy(() => tblCustUsersUpdateManyWithoutTblUsersNestedInputObjectSchema).optional(),
  tblUserAccess: z.lazy(() => tblUserAccessUpdateManyWithoutTblUsersNestedInputObjectSchema).optional(),
  tblUserParams: z.lazy(() => tblUserParamsUpdateManyWithoutTblUsersNestedInputObjectSchema).optional()
}).strict();
export const tblUsersUpdateInputObjectSchema: z.ZodType<Prisma.tblUsersUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.tblUsersUpdateInput>;
export const tblUsersUpdateInputObjectZodSchema = makeSchema();
