...
export const tblAgrRightsUncheckedCreateWithoutDictRoyAccountIntervalInputObjectSchema: z.ZodType<Prisma.tblAgrRightsUncheckedCreateWithoutDictRoyAccountIntervalInput> = makeSchema() as unknown as z.ZodType<Prisma.tblAgrRightsUncheckedCreateWithoutDictRoyAccountIntervalInput>;
export const tblAgrRightsUncheckedCreateWithoutDictRoyAccountIntervalInputObjectZodSchema = makeSchema();
