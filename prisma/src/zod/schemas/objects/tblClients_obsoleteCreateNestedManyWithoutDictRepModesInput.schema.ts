...
export const tblClients_obsoleteCreateNestedManyWithoutDictRepModesInputObjectSchema: z.ZodType<Prisma.tblClients_obsoleteCreateNestedManyWithoutDictRepModesInput> = makeSchema() as unknown as z.ZodType<Prisma.tblClients_obsoleteCreateNestedManyWithoutDictRepModesInput>;
export const tblClients_obsoleteCreateNestedManyWithoutDictRepModesInputObjectZodSchema = makeSchema();
