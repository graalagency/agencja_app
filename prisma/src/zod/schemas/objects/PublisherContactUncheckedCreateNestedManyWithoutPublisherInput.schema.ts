...
export const PublisherContactUncheckedCreateNestedManyWithoutPublisherInputObjectSchema: z.ZodType<Prisma.PublisherContactUncheckedCreateNestedManyWithoutPublisherInput> = makeSchema() as unknown as z.ZodType<Prisma.PublisherContactUncheckedCreateNestedManyWithoutPublisherInput>;
export const PublisherContactUncheckedCreateNestedManyWithoutPublisherInputObjectZodSchema = makeSchema();
