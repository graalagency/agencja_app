...
export const tblCustBankUncheckedCreateNestedOneWithoutTblCustomersInputObjectSchema: z.ZodType<Prisma.tblCustBankUncheckedCreateNestedOneWithoutTblCustomersInput> = makeSchema() as unknown as z.ZodType<Prisma.tblCustBankUncheckedCreateNestedOneWithoutTblCustomersInput>;
export const tblCustBankUncheckedCreateNestedOneWithoutTblCustomersInputObjectZodSchema = makeSchema();
