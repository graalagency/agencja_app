...
export const PublisherCountOutputTypeCountTaxResidenceCertArgsObjectSchema = makeSchema();
export const PublisherCountOutputTypeCountTaxResidenceCertArgsObjectZodSchema = makeSchema();
