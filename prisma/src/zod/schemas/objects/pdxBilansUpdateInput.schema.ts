...
export const pdxBilansUpdateInputObjectSchema: z.ZodType<Prisma.pdxBilansUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.pdxBilansUpdateInput>;
export const pdxBilansUpdateInputObjectZodSchema = makeSchema();
