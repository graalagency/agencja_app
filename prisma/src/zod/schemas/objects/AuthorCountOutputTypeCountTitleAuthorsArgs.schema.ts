...
export const AuthorCountOutputTypeCountTitleAuthorsArgsObjectSchema = makeSchema();
export const AuthorCountOutputTypeCountTitleAuthorsArgsObjectZodSchema = makeSchema();
