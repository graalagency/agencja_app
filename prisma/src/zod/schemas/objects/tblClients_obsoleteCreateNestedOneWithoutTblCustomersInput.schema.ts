...
export const tblClients_obsoleteCreateNestedOneWithoutTblCustomersInputObjectSchema: z.ZodType<Prisma.tblClients_obsoleteCreateNestedOneWithoutTblCustomersInput> = makeSchema() as unknown as z.ZodType<Prisma.tblClients_obsoleteCreateNestedOneWithoutTblCustomersInput>;
export const tblClients_obsoleteCreateNestedOneWithoutTblCustomersInputObjectZodSchema = makeSchema();
