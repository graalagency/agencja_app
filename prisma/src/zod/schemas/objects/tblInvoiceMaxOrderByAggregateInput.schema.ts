...
export const tblInvoiceMaxOrderByAggregateInputObjectSchema: z.ZodType<Prisma.tblInvoiceMaxOrderByAggregateInput> = makeSchema() as unknown as z.ZodType<Prisma.tblInvoiceMaxOrderByAggregateInput>;
export const tblInvoiceMaxOrderByAggregateInputObjectZodSchema = makeSchema();
