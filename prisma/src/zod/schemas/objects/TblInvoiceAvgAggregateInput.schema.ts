...
export const TblInvoiceAvgAggregateInputObjectSchema: z.ZodType<Prisma.TblInvoiceAvgAggregateInputType> = makeSchema() as unknown as z.ZodType<Prisma.TblInvoiceAvgAggregateInputType>;
export const TblInvoiceAvgAggregateInputObjectZodSchema = makeSchema();
