...
import { tblRoyRatesUncheckedUpdateManyWithoutTblAgreementsNestedInputObjectSchema as tblRoyRatesUncheckedUpdateManyWithoutTblAgreementsNestedInputObjectSchema } from './tblRoyRatesUncheckedUpdateManyWithoutTblAgreementsNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  LangAbbr: z.union([z.string().max(3), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  ...
  tblRoyRates: z.lazy(() => tblRoyRatesUncheckedUpdateManyWithoutTblAgreementsNestedInputObjectSchema).optional()
}).strict();
export const tblAgreementsUncheckedUpdateInputObjectSchema: z.ZodType<Prisma.tblAgreementsUncheckedUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.tblAgreementsUncheckedUpdateInput>;
export const tblAgreementsUncheckedUpdateInputObjectZodSchema = makeSchema();
