...
export const dictAdvTypeUpdateInputObjectSchema: z.ZodType<Prisma.dictAdvTypeUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.dictAdvTypeUpdateInput>;
export const dictAdvTypeUpdateInputObjectZodSchema = makeSchema();
