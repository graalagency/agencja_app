...
import { tblCustUsersCreateNestedManyWithoutTblUsersInputObjectSchema as tblCustUsersCreateNestedManyWithoutTblUsersInputObjectSchema } from './tblCustUsersCreateNestedManyWithoutTblUsersInput.schema';
...
const makeSchema = () => z.object({
  ...
  tblCustUsers: z.lazy(() => tblCustUsersCreateNestedManyWithoutTblUsersInputObjectSchema).optional(),
  tblUserAccess: z.lazy(() => tblUserAccessCreateNestedManyWithoutTblUsersInputObjectSchema).optional()
}).strict();
export const tblUsersCreateWithoutTblUserParamsInputObjectSchema: z.ZodType<Prisma.tblUsersCreateWithoutTblUserParamsInput> = makeSchema() as unknown as z.ZodType<Prisma.tblUsersCreateWithoutTblUserParamsInput>;
export const tblUsersCreateWithoutTblUserParamsInputObjectZodSchema = makeSchema();
