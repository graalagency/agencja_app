...
import { tblAgreementsUpdateOneRequiredWithoutTblRoyaltyNestedInputObjectSchema as tblAgreementsUpdateOneRequiredWithoutTblRoyaltyNestedInputObjectSchema } from './tblAgreementsUpdateOneRequiredWithoutTblRoyaltyNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  tblAgreements: z.lazy(() => tblAgreementsUpdateOneRequiredWithoutTblRoyaltyNestedInputObjectSchema).optional()
}).strict();
export const tblRoyaltyUpdateInputObjectSchema: z.ZodType<Prisma.tblRoyaltyUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.tblRoyaltyUpdateInput>;
export const tblRoyaltyUpdateInputObjectZodSchema = makeSchema();
