...
export const ClientCountOutputTypeCountTaxResidenceSendArgsObjectSchema = makeSchema();
export const ClientCountOutputTypeCountTaxResidenceSendArgsObjectZodSchema = makeSchema();
