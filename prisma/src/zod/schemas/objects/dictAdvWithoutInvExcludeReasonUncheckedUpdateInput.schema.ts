...
export const dictAdvWithoutInvExcludeReasonUncheckedUpdateInputObjectSchema: z.ZodType<Prisma.dictAdvWithoutInvExcludeReasonUncheckedUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.dictAdvWithoutInvExcludeReasonUncheckedUpdateInput>;
export const dictAdvWithoutInvExcludeReasonUncheckedUpdateInputObjectZodSchema = makeSchema();
