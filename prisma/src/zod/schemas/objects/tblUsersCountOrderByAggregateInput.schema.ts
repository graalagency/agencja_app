...
export const tblUsersCountOrderByAggregateInputObjectSchema: z.ZodType<Prisma.tblUsersCountOrderByAggregateInput> = makeSchema() as unknown as z.ZodType<Prisma.tblUsersCountOrderByAggregateInput>;
export const tblUsersCountOrderByAggregateInputObjectZodSchema = makeSchema();
