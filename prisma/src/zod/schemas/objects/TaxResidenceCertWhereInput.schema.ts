...
const taxresidencecertwhereinputSchema = z.object({
  AND: z.union([z.lazy(() => TaxResidenceCertWhereInputObjectSchema), z.lazy(() => TaxResidenceCertWhereInputObjectSchema).array()]).optional(),
  OR: z.lazy(() => TaxResidenceCertWhereInputObjectSchema).array().optional(),
  NOT: z.union([z.lazy(() => TaxResidenceCertWhereInputObjectSchema), z.lazy(() => TaxResidenceCertWhereInputObjectSchema).array()]).optional(),
  ...
  SendLog: z.lazy(() => TaxResidenceSendListRelationFilterObjectSchema).optional()
}).strict();
export const TaxResidenceCertWhereInputObjectSchema: z.ZodType<Prisma.TaxResidenceCertWhereInput> = taxresidencecertwhereinputSchema as unknown as z.ZodType<Prisma.TaxResidenceCertWhereInput>;
export const TaxResidenceCertWhereInputObjectZodSchema = taxresidencecertwhereinputSchema;
