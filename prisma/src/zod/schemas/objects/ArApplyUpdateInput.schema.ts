...
import { ArTransactionUpdateOneRequiredWithoutArApplyNestedInputObjectSchema as ArTransactionUpdateOneRequiredWithoutArApplyNestedInputObjectSchema } from './ArTransactionUpdateOneRequiredWithoutArApplyNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  ArTransaction: z.lazy(() => ArTransactionUpdateOneRequiredWithoutArApplyNestedInputObjectSchema).optional()
}).strict();
export const ArApplyUpdateInputObjectSchema: z.ZodType<Prisma.ArApplyUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.ArApplyUpdateInput>;
export const ArApplyUpdateInputObjectZodSchema = makeSchema();
