...
export const TaxResidenceCertCountOutputTypeCountSendLogArgsObjectSchema = makeSchema();
export const TaxResidenceCertCountOutputTypeCountSendLogArgsObjectZodSchema = makeSchema();
