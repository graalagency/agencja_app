...
export const tblInvoiceDetailsFindFirstSelectSchema: z.ZodType<Prisma.tblInvoiceDetailsSelect> = z.object({
...
export const tblInvoiceDetailsFindFirstSelectZodSchema = z.object({
    InvNum: z.boolean().optional(),
    InvDetKey: z.boolean().optional(),
    InvType: z.boolean().optional(),
    AgID: z.boolean().optional(),
...
export const tblInvoiceDetailsFindFirstSchema: z.ZodType<Prisma.tblInvoiceDetailsFindFirstArgs> = z.object({ select: tblInvoiceDetailsFindFirstSelectSchema.optional(),  orderBy: z.union([tblInvoiceDetailsOrderByWithRelationInputObjectSchema, tblInvoiceDetailsOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblInvoiceDetailsWhereInputObjectSchema.optional(), cursor: tblInvoiceDetailsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblInvoiceDetailsScalarFieldEnumSchema, TblInvoiceDetailsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblInvoiceDetailsFindFirstArgs>;

export const tblInvoiceDetailsFindFirstZodSchema = z.object({ select: tblInvoiceDetailsFindFirstSelectSchema.optional(),  orderBy: z.union([tblInvoiceDetailsOrderByWithRelationInputObjectSchema, tblInvoiceDetailsOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblInvoiceDetailsWhereInputObjectSchema.optional(), cursor: tblInvoiceDetailsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblInvoiceDetailsScalarFieldEnumSchema, TblInvoiceDetailsScalarFieldEnumSchema.array()]).optional() }).strict();