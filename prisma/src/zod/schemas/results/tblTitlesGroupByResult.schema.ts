...
export const tblTitlesGroupByResultSchema = z.array(z.object({
  ...
  ISBN3: z.string(),
  ISBN4: z.string(),
  SeriesIID: z.number().int(),
  Edition: z.number().int(),
  DateOfReceipt: z.date(),
  NoOfPages: z.number().int(),
  CopyrightYear: z.string(),
  CopyrightOwner: z.string(),
  CopyrightOwnerDesc: z.string(),
  KeyWords: z.string(),
  TitleVolume: z.number().int(),
  NoOfTitleVolumes: z.number().int(),
  Hit: z.boolean(),
  Junk: z.boolean(),
  CD: z.boolean(),
