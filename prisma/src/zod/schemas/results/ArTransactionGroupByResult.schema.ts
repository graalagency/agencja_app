...
export const ArTransactionGroupByResultSchema = z.array(z.object({
  TransactionID: z.number().int(),
  DefaultDocRef: z.string(),
  InvNr: z.number().int(),
  TransactionDate: z.date(),
  TransactionType: z.number().int(),
  Currency: z.string(),
  TransactionAmt: z.number(),
  RCustID: z.number().int(),
  PCustID: z.number().int(),
  RBalance: z.number(),
  PBalance: z.number(),
  IFTBalance: z.number(),
  GraalBalance: z.number(),
  ClientReference: z.string(),
  OurBankTransRef: z.string(),
  NetDate: z.date(),
  IsChargeInterest: z.boolean(),
  Notes: z.string(),
  ReversalTransID: z.number().int(),
  OriginTransID: z.number().int(),
  EntryDate: z.date(),
