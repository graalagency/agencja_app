...
export const tblPersonFindFirstOrThrowSelectSchema: z.ZodType<Prisma.tblPersonSelect> = z.object({
...
export const tblPersonFindFirstOrThrowSelectZodSchema = z.object({
    PersonID: z.boolean().optional(),
    LastName: z.boolean().optional(),
    FirstName: z.boolean().optional(),
    MiddleName: z.boolean().optional(),
...
export const tblPersonFindFirstOrThrowSchema: z.ZodType<Prisma.tblPersonFindFirstOrThrowArgs> = z.object({ select: tblPersonFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([tblPersonOrderByWithRelationInputObjectSchema, tblPersonOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblPersonWhereInputObjectSchema.optional(), cursor: tblPersonWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblPersonScalarFieldEnumSchema, TblPersonScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblPersonFindFirstOrThrowArgs>;

export const tblPersonFindFirstOrThrowZodSchema = z.object({ select: tblPersonFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([tblPersonOrderByWithRelationInputObjectSchema, tblPersonOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblPersonWhereInputObjectSchema.optional(), cursor: tblPersonWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblPersonScalarFieldEnumSchema, TblPersonScalarFieldEnumSchema.array()]).optional() }).strict();