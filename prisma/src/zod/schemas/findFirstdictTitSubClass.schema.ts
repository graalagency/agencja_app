...
export const dictTitSubClassFindFirstSelectSchema: z.ZodType<Prisma.dictTitSubClassSelect> = z.object({
...
export const dictTitSubClassFindFirstSelectZodSchema = z.object({
    SubClassCode: z.boolean().optional(),
    ClassCode: z.boolean().optional(),
    SubClassDesc: z.boolean().optional(),
    dictTitMainClass: z.boolean().optional(),
...
export const dictTitSubClassFindFirstSchema: z.ZodType<Prisma.dictTitSubClassFindFirstArgs> = z.object({ select: dictTitSubClassFindFirstSelectSchema.optional(), include: z.lazy(() => dictTitSubClassIncludeObjectSchema.optional()), orderBy: z.union([dictTitSubClassOrderByWithRelationInputObjectSchema, dictTitSubClassOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictTitSubClassWhereInputObjectSchema.optional(), cursor: dictTitSubClassWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictTitSubClassScalarFieldEnumSchema, DictTitSubClassScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.dictTitSubClassFindFirstArgs>;

export const dictTitSubClassFindFirstZodSchema = z.object({ select: dictTitSubClassFindFirstSelectSchema.optional(), include: z.lazy(() => dictTitSubClassIncludeObjectSchema.optional()), orderBy: z.union([dictTitSubClassOrderByWithRelationInputObjectSchema, dictTitSubClassOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictTitSubClassWhereInputObjectSchema.optional(), cursor: dictTitSubClassWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictTitSubClassScalarFieldEnumSchema, DictTitSubClassScalarFieldEnumSchema.array()]).optional() }).strict();