...
export const dictRoyAccountIntervalFindFirstOrThrowSelectSchema: z.ZodType<Prisma.dictRoyAccountIntervalSelect> = z.object({
...
export const dictRoyAccountIntervalFindFirstOrThrowSelectZodSchema = z.object({
    RoyAccountIntervalID: z.boolean().optional(),
    RoyAccountIntervalDesc: z.boolean().optional(),
    IntervalAbb: z.boolean().optional(),
    tblAgrRights: z.boolean().optional(),
...
export const dictRoyAccountIntervalFindFirstOrThrowSchema: z.ZodType<Prisma.dictRoyAccountIntervalFindFirstOrThrowArgs> = z.object({ select: dictRoyAccountIntervalFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => dictRoyAccountIntervalIncludeObjectSchema.optional()), orderBy: z.union([dictRoyAccountIntervalOrderByWithRelationInputObjectSchema, dictRoyAccountIntervalOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictRoyAccountIntervalWhereInputObjectSchema.optional(), cursor: dictRoyAccountIntervalWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictRoyAccountIntervalScalarFieldEnumSchema, DictRoyAccountIntervalScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.dictRoyAccountIntervalFindFirstOrThrowArgs>;

export const dictRoyAccountIntervalFindFirstOrThrowZodSchema = z.object({ select: dictRoyAccountIntervalFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => dictRoyAccountIntervalIncludeObjectSchema.optional()), orderBy: z.union([dictRoyAccountIntervalOrderByWithRelationInputObjectSchema, dictRoyAccountIntervalOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictRoyAccountIntervalWhereInputObjectSchema.optional(), cursor: dictRoyAccountIntervalWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictRoyAccountIntervalScalarFieldEnumSchema, DictRoyAccountIntervalScalarFieldEnumSchema.array()]).optional() }).strict();