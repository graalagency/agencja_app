...
export const ArApplyFindFirstSelectSchema: z.ZodType<Prisma.ArApplySelect> = z.object({
...
export const ArApplyFindFirstSelectZodSchema = z.object({
    ApplyID: z.boolean().optional(),
    DebitID: z.boolean().optional(),
    CreditID: z.boolean().optional(),
    TaxPerc: z.boolean().optional(),
...
export const ArApplyFindFirstSchema: z.ZodType<Prisma.ArApplyFindFirstArgs> = z.object({ select: ArApplyFindFirstSelectSchema.optional(), include: z.lazy(() => ArApplyIncludeObjectSchema.optional()), orderBy: z.union([ArApplyOrderByWithRelationInputObjectSchema, ArApplyOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArApplyWhereInputObjectSchema.optional(), cursor: ArApplyWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArApplyScalarFieldEnumSchema, ArApplyScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ArApplyFindFirstArgs>;

export const ArApplyFindFirstZodSchema = z.object({ select: ArApplyFindFirstSelectSchema.optional(), include: z.lazy(() => ArApplyIncludeObjectSchema.optional()), orderBy: z.union([ArApplyOrderByWithRelationInputObjectSchema, ArApplyOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArApplyWhereInputObjectSchema.optional(), cursor: ArApplyWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArApplyScalarFieldEnumSchema, ArApplyScalarFieldEnumSchema.array()]).optional() }).strict();