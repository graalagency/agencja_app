...
export const dictDistributionTypeFindFirstSelectSchema: z.ZodType<Prisma.dictDistributionTypeSelect> = z.object({
...
export const dictDistributionTypeFindFirstSelectZodSchema = z.object({
    DistID: z.boolean().optional(),
    DistDesc: z.boolean().optional(),
    tblAgrRights: z.boolean().optional(),
    _count: z.boolean().optional()
...
export const dictDistributionTypeFindFirstSchema: z.ZodType<Prisma.dictDistributionTypeFindFirstArgs> = z.object({ select: dictDistributionTypeFindFirstSelectSchema.optional(), include: z.lazy(() => dictDistributionTypeIncludeObjectSchema.optional()), orderBy: z.union([dictDistributionTypeOrderByWithRelationInputObjectSchema, dictDistributionTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictDistributionTypeWhereInputObjectSchema.optional(), cursor: dictDistributionTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictDistributionTypeScalarFieldEnumSchema, DictDistributionTypeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.dictDistributionTypeFindFirstArgs>;

export const dictDistributionTypeFindFirstZodSchema = z.object({ select: dictDistributionTypeFindFirstSelectSchema.optional(), include: z.lazy(() => dictDistributionTypeIncludeObjectSchema.optional()), orderBy: z.union([dictDistributionTypeOrderByWithRelationInputObjectSchema, dictDistributionTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictDistributionTypeWhereInputObjectSchema.optional(), cursor: dictDistributionTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictDistributionTypeScalarFieldEnumSchema, DictDistributionTypeScalarFieldEnumSchema.array()]).optional() }).strict();