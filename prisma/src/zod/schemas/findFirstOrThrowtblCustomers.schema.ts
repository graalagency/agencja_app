...
export const tblCustomersFindFirstOrThrowSelectSchema: z.ZodType<Prisma.tblCustomersSelect> = z.object({
...
export const tblCustomersFindFirstOrThrowSelectZodSchema = z.object({
    CustID: z.boolean().optional(),
    CustAbb: z.boolean().optional(),
    Account: z.boolean().optional(),
    CountryID: z.boolean().optional(),
...
export const tblCustomersFindFirstOrThrowSchema: z.ZodType<Prisma.tblCustomersFindFirstOrThrowArgs> = z.object({ select: tblCustomersFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tblCustomersIncludeObjectSchema.optional()), orderBy: z.union([tblCustomersOrderByWithRelationInputObjectSchema, tblCustomersOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblCustomersWhereInputObjectSchema.optional(), cursor: tblCustomersWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblCustomersScalarFieldEnumSchema, TblCustomersScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblCustomersFindFirstOrThrowArgs>;

export const tblCustomersFindFirstOrThrowZodSchema = z.object({ select: tblCustomersFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tblCustomersIncludeObjectSchema.optional()), orderBy: z.union([tblCustomersOrderByWithRelationInputObjectSchema, tblCustomersOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblCustomersWhereInputObjectSchema.optional(), cursor: tblCustomersWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblCustomersScalarFieldEnumSchema, TblCustomersScalarFieldEnumSchema.array()]).optional() }).strict();