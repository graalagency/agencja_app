...
export const PublisherContactFindManySelectSchema: z.ZodType<Prisma.PublisherContactSelect> = z.object({
...
export const PublisherContactFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    contactId: z.boolean().optional(),
    publisherId: z.boolean().optional(),
    isDefault: z.boolean().optional(),
...
export const PublisherContactFindManySchema: z.ZodType<Prisma.PublisherContactFindManyArgs> = z.object({ select: PublisherContactFindManySelectSchema.optional(), include: z.lazy(() => PublisherContactIncludeObjectSchema.optional()), orderBy: z.union([PublisherContactOrderByWithRelationInputObjectSchema, PublisherContactOrderByWithRelationInputObjectSchema.array()]).optional(), where: PublisherContactWhereInputObjectSchema.optional(), cursor: PublisherContactWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PublisherContactScalarFieldEnumSchema, PublisherContactScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PublisherContactFindManyArgs>;

export const PublisherContactFindManyZodSchema = z.object({ select: PublisherContactFindManySelectSchema.optional(), include: z.lazy(() => PublisherContactIncludeObjectSchema.optional()), orderBy: z.union([PublisherContactOrderByWithRelationInputObjectSchema, PublisherContactOrderByWithRelationInputObjectSchema.array()]).optional(), where: PublisherContactWhereInputObjectSchema.optional(), cursor: PublisherContactWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PublisherContactScalarFieldEnumSchema, PublisherContactScalarFieldEnumSchema.array()]).optional() }).strict();