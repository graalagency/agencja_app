...
export const dictRoyTypeFindFirstOrThrowSelectSchema: z.ZodType<Prisma.dictRoyTypeSelect> = z.object({
...
export const dictRoyTypeFindFirstOrThrowSelectZodSchema = z.object({
    RoyTypeID: z.boolean().optional(),
    AgrRightID: z.boolean().optional(),
    RoyTypeDesc: z.boolean().optional(),
    tblAgrRights: z.boolean().optional()
...
export const dictRoyTypeFindFirstOrThrowSchema: z.ZodType<Prisma.dictRoyTypeFindFirstOrThrowArgs> = z.object({ select: dictRoyTypeFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => dictRoyTypeIncludeObjectSchema.optional()), orderBy: z.union([dictRoyTypeOrderByWithRelationInputObjectSchema, dictRoyTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictRoyTypeWhereInputObjectSchema.optional(), cursor: dictRoyTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictRoyTypeScalarFieldEnumSchema, DictRoyTypeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.dictRoyTypeFindFirstOrThrowArgs>;

export const dictRoyTypeFindFirstOrThrowZodSchema = z.object({ select: dictRoyTypeFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => dictRoyTypeIncludeObjectSchema.optional()), orderBy: z.union([dictRoyTypeOrderByWithRelationInputObjectSchema, dictRoyTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictRoyTypeWhereInputObjectSchema.optional(), cursor: dictRoyTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictRoyTypeScalarFieldEnumSchema, DictRoyTypeScalarFieldEnumSchema.array()]).optional() }).strict();