...
export const ArTransactionFindManySelectSchema: z.ZodType<Prisma.ArTransactionSelect> = z.object({
...
export const ArTransactionFindManySelectZodSchema = z.object({
    TransactionID: z.boolean().optional(),
    DefaultDocRef: z.boolean().optional(),
    InvNr: z.boolean().optional(),
    TransactionDate: z.boolean().optional(),
...
export const ArTransactionFindManySchema: z.ZodType<Prisma.ArTransactionFindManyArgs> = z.object({ select: ArTransactionFindManySelectSchema.optional(), include: z.lazy(() => ArTransactionIncludeObjectSchema.optional()), orderBy: z.union([ArTransactionOrderByWithRelationInputObjectSchema, ArTransactionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArTransactionWhereInputObjectSchema.optional(), cursor: ArTransactionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArTransactionScalarFieldEnumSchema, ArTransactionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ArTransactionFindManyArgs>;

export const ArTransactionFindManyZodSchema = z.object({ select: ArTransactionFindManySelectSchema.optional(), include: z.lazy(() => ArTransactionIncludeObjectSchema.optional()), orderBy: z.union([ArTransactionOrderByWithRelationInputObjectSchema, ArTransactionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ArTransactionWhereInputObjectSchema.optional(), cursor: ArTransactionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ArTransactionScalarFieldEnumSchema, ArTransactionScalarFieldEnumSchema.array()]).optional() }).strict();