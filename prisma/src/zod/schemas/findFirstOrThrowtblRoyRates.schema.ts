...
export const tblRoyRatesFindFirstOrThrowSelectSchema: z.ZodType<Prisma.tblRoyRatesSelect> = z.object({
...
export const tblRoyRatesFindFirstOrThrowSelectZodSchema = z.object({
    Step: z.boolean().optional(),
    AgrRightID: z.boolean().optional(),
    AgrID: z.boolean().optional(),
    CpsMax: z.boolean().optional(),
...
export const tblRoyRatesFindFirstOrThrowSchema: z.ZodType<Prisma.tblRoyRatesFindFirstOrThrowArgs> = z.object({ select: tblRoyRatesFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tblRoyRatesIncludeObjectSchema.optional()), orderBy: z.union([tblRoyRatesOrderByWithRelationInputObjectSchema, tblRoyRatesOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblRoyRatesWhereInputObjectSchema.optional(), cursor: tblRoyRatesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblRoyRatesScalarFieldEnumSchema, TblRoyRatesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblRoyRatesFindFirstOrThrowArgs>;

export const tblRoyRatesFindFirstOrThrowZodSchema = z.object({ select: tblRoyRatesFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tblRoyRatesIncludeObjectSchema.optional()), orderBy: z.union([tblRoyRatesOrderByWithRelationInputObjectSchema, tblRoyRatesOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblRoyRatesWhereInputObjectSchema.optional(), cursor: tblRoyRatesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblRoyRatesScalarFieldEnumSchema, TblRoyRatesScalarFieldEnumSchema.array()]).optional() }).strict();