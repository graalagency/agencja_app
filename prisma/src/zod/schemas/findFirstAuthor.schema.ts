...
export const AuthorFindFirstZodSchema = z.object({ select: AuthorFindFirstSelectSchema.optional(), include: z.lazy(() => AuthorIncludeObjectSchema.optional()), orderBy: z.union([AuthorOrderByWithRelationInputObjectSchema, AuthorOrderByWithRelationInputObjectSchema.array()]).optional(), where: AuthorWhereInputObjectSchema.optional(), cursor: AuthorWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AuthorScalarFieldEnumSchema, AuthorScalarFieldEnumSchema.array()]).optional() }).strict();