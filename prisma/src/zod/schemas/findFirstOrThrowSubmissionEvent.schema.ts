...
export const SubmissionEventFindFirstOrThrowSelectSchema: z.ZodType<Prisma.SubmissionEventSelect> = z.object({
...
export const SubmissionEventFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    sourceId: z.boolean().optional(),
    submissionId: z.boolean().optional(),
    eventCode: z.boolean().optional(),
...
export const SubmissionEventFindFirstOrThrowSchema: z.ZodType<Prisma.SubmissionEventFindFirstOrThrowArgs> = z.object({ select: SubmissionEventFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => SubmissionEventIncludeObjectSchema.optional()), orderBy: z.union([SubmissionEventOrderByWithRelationInputObjectSchema, SubmissionEventOrderByWithRelationInputObjectSchema.array()]).optional(), where: SubmissionEventWhereInputObjectSchema.optional(), cursor: SubmissionEventWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SubmissionEventScalarFieldEnumSchema, SubmissionEventScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SubmissionEventFindFirstOrThrowArgs>;

export const SubmissionEventFindFirstOrThrowZodSchema = z.object({ select: SubmissionEventFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => SubmissionEventIncludeObjectSchema.optional()), orderBy: z.union([SubmissionEventOrderByWithRelationInputObjectSchema, SubmissionEventOrderByWithRelationInputObjectSchema.array()]).optional(), where: SubmissionEventWhereInputObjectSchema.optional(), cursor: SubmissionEventWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SubmissionEventScalarFieldEnumSchema, SubmissionEventScalarFieldEnumSchema.array()]).optional() }).strict();