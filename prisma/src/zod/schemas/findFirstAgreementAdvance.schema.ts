...
export const AgreementAdvanceFindFirstSelectSchema: z.ZodType<Prisma.AgreementAdvanceSelect> = z.object({
...
export const AgreementAdvanceFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    sourceId: z.boolean().optional(),
    agreementId: z.boolean().optional(),
    instalment: z.boolean().optional(),
...
export const AgreementAdvanceFindFirstSchema: z.ZodType<Prisma.AgreementAdvanceFindFirstArgs> = z.object({ select: AgreementAdvanceFindFirstSelectSchema.optional(), include: z.lazy(() => AgreementAdvanceIncludeObjectSchema.optional()), orderBy: z.union([AgreementAdvanceOrderByWithRelationInputObjectSchema, AgreementAdvanceOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgreementAdvanceWhereInputObjectSchema.optional(), cursor: AgreementAdvanceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgreementAdvanceScalarFieldEnumSchema, AgreementAdvanceScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AgreementAdvanceFindFirstArgs>;

export const AgreementAdvanceFindFirstZodSchema = z.object({ select: AgreementAdvanceFindFirstSelectSchema.optional(), include: z.lazy(() => AgreementAdvanceIncludeObjectSchema.optional()), orderBy: z.union([AgreementAdvanceOrderByWithRelationInputObjectSchema, AgreementAdvanceOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgreementAdvanceWhereInputObjectSchema.optional(), cursor: AgreementAdvanceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgreementAdvanceScalarFieldEnumSchema, AgreementAdvanceScalarFieldEnumSchema.array()]).optional() }).strict();