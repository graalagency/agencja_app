...
export const tblAuthorsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.tblAuthorsSelect> = z.object({
...
export const tblAuthorsFindFirstOrThrowSelectZodSchema = z.object({
    AuthorID: z.boolean().optional(),
    FullName: z.boolean().optional(),
    FirstName: z.boolean().optional(),
    MiddleName: z.boolean().optional(),
...
export const tblAuthorsFindFirstOrThrowSchema: z.ZodType<Prisma.tblAuthorsFindFirstOrThrowArgs> = z.object({ select: tblAuthorsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tblAuthorsIncludeObjectSchema.optional()), orderBy: z.union([tblAuthorsOrderByWithRelationInputObjectSchema, tblAuthorsOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblAuthorsWhereInputObjectSchema.optional(), cursor: tblAuthorsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblAuthorsScalarFieldEnumSchema, TblAuthorsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblAuthorsFindFirstOrThrowArgs>;

export const tblAuthorsFindFirstOrThrowZodSchema = z.object({ select: tblAuthorsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tblAuthorsIncludeObjectSchema.optional()), orderBy: z.union([tblAuthorsOrderByWithRelationInputObjectSchema, tblAuthorsOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblAuthorsWhereInputObjectSchema.optional(), cursor: tblAuthorsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblAuthorsScalarFieldEnumSchema, TblAuthorsScalarFieldEnumSchema.array()]).optional() }).strict();