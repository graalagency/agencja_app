...
export const tblUsersFindManySelectSchema: z.ZodType<Prisma.tblUsersSelect> = z.object({
...
export const tblUsersFindManySelectZodSchema = z.object({
    Login: z.boolean().optional(),
    FirstName: z.boolean().optional(),
    MiddleName: z.boolean().optional(),
    LastName: z.boolean().optional(),
...
export const tblUsersFindManySchema: z.ZodType<Prisma.tblUsersFindManyArgs> = z.object({ select: tblUsersFindManySelectSchema.optional(), include: z.lazy(() => tblUsersIncludeObjectSchema.optional()), orderBy: z.union([tblUsersOrderByWithRelationInputObjectSchema, tblUsersOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblUsersWhereInputObjectSchema.optional(), cursor: tblUsersWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblUsersScalarFieldEnumSchema, TblUsersScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblUsersFindManyArgs>;

export const tblUsersFindManyZodSchema = z.object({ select: tblUsersFindManySelectSchema.optional(), include: z.lazy(() => tblUsersIncludeObjectSchema.optional()), orderBy: z.union([tblUsersOrderByWithRelationInputObjectSchema, tblUsersOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblUsersWhereInputObjectSchema.optional(), cursor: tblUsersWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblUsersScalarFieldEnumSchema, TblUsersScalarFieldEnumSchema.array()]).optional() }).strict();