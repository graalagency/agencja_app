...
export const dictPriceTypeFindFirstSelectSchema: z.ZodType<Prisma.dictPriceTypeSelect> = z.object({
...
export const dictPriceTypeFindFirstSelectZodSchema = z.object({
    PriceTypeID: z.boolean().optional(),
    PriceTypeDesc: z.boolean().optional(),
    PriceTypePL: z.boolean().optional(),
    tblAgrRights: z.boolean().optional(),
...
export const dictPriceTypeFindFirstSchema: z.ZodType<Prisma.dictPriceTypeFindFirstArgs> = z.object({ select: dictPriceTypeFindFirstSelectSchema.optional(), include: z.lazy(() => dictPriceTypeIncludeObjectSchema.optional()), orderBy: z.union([dictPriceTypeOrderByWithRelationInputObjectSchema, dictPriceTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictPriceTypeWhereInputObjectSchema.optional(), cursor: dictPriceTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictPriceTypeScalarFieldEnumSchema, DictPriceTypeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.dictPriceTypeFindFirstArgs>;

export const dictPriceTypeFindFirstZodSchema = z.object({ select: dictPriceTypeFindFirstSelectSchema.optional(), include: z.lazy(() => dictPriceTypeIncludeObjectSchema.optional()), orderBy: z.union([dictPriceTypeOrderByWithRelationInputObjectSchema, dictPriceTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictPriceTypeWhereInputObjectSchema.optional(), cursor: dictPriceTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictPriceTypeScalarFieldEnumSchema, DictPriceTypeScalarFieldEnumSchema.array()]).optional() }).strict();