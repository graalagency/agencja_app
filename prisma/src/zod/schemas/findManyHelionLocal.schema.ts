...
export const HelionLocalFindManySelectSchema: z.ZodType<Prisma.HelionLocalSelect> = z.object({
...
export const HelionLocalFindManySelectZodSchema = z.object({
    ISBNORG: z.boolean().optional(),
    ISBNHELION: z.boolean().optional(),
    TYTULORG: z.boolean().optional(),
    TYTULHELION: z.boolean().optional()
...
export const HelionLocalFindManySchema: z.ZodType<Prisma.HelionLocalFindManyArgs> = z.object({ select: HelionLocalFindManySelectSchema.optional(),  orderBy: z.union([HelionLocalOrderByWithRelationInputObjectSchema, HelionLocalOrderByWithRelationInputObjectSchema.array()]).optional(), where: HelionLocalWhereInputObjectSchema.optional(), cursor: HelionLocalWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([HelionLocalScalarFieldEnumSchema, HelionLocalScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.HelionLocalFindManyArgs>;

export const HelionLocalFindManyZodSchema = z.object({ select: HelionLocalFindManySelectSchema.optional(),  orderBy: z.union([HelionLocalOrderByWithRelationInputObjectSchema, HelionLocalOrderByWithRelationInputObjectSchema.array()]).optional(), where: HelionLocalWhereInputObjectSchema.optional(), cursor: HelionLocalWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([HelionLocalScalarFieldEnumSchema, HelionLocalScalarFieldEnumSchema.array()]).optional() }).strict();