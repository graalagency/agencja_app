...
export const tblRoyaltyFindFirstSelectSchema: z.ZodType<Prisma.tblRoyaltySelect> = z.object({
...
export const tblRoyaltyFindFirstSelectZodSchema = z.object({
    RoyID: z.boolean().optional(),
    AgrID: z.boolean().optional(),
    AgrRightID: z.boolean().optional(),
    RoyNr: z.boolean().optional(),
...
export const tblRoyaltyFindFirstSchema: z.ZodType<Prisma.tblRoyaltyFindFirstArgs> = z.object({ select: tblRoyaltyFindFirstSelectSchema.optional(), include: z.lazy(() => tblRoyaltyIncludeObjectSchema.optional()), orderBy: z.union([tblRoyaltyOrderByWithRelationInputObjectSchema, tblRoyaltyOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblRoyaltyWhereInputObjectSchema.optional(), cursor: tblRoyaltyWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblRoyaltyScalarFieldEnumSchema, TblRoyaltyScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblRoyaltyFindFirstArgs>;

export const tblRoyaltyFindFirstZodSchema = z.object({ select: tblRoyaltyFindFirstSelectSchema.optional(), include: z.lazy(() => tblRoyaltyIncludeObjectSchema.optional()), orderBy: z.union([tblRoyaltyOrderByWithRelationInputObjectSchema, tblRoyaltyOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblRoyaltyWhereInputObjectSchema.optional(), cursor: tblRoyaltyWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblRoyaltyScalarFieldEnumSchema, TblRoyaltyScalarFieldEnumSchema.array()]).optional() }).strict();