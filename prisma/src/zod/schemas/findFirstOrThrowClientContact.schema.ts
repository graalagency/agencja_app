...
export const ClientContactFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ClientContactSelect> = z.object({
...
export const ClientContactFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    contactId: z.boolean().optional(),
    clientId: z.boolean().optional(),
    isDefault: z.boolean().optional(),
