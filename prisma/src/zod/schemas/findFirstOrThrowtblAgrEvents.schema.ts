...
export const tblAgrEventsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.tblAgrEventsSelect> = z.object({
...
export const tblAgrEventsFindFirstOrThrowSelectZodSchema = z.object({
    AgrEventID: z.boolean().optional(),
    AgrID: z.boolean().optional(),
    AgrEventCode: z.boolean().optional(),
    EventDate: z.boolean().optional(),
...
export const tblAgrEventsFindFirstOrThrowSchema: z.ZodType<Prisma.tblAgrEventsFindFirstOrThrowArgs> = z.object({ select: tblAgrEventsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tblAgrEventsIncludeObjectSchema.optional()), orderBy: z.union([tblAgrEventsOrderByWithRelationInputObjectSchema, tblAgrEventsOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblAgrEventsWhereInputObjectSchema.optional(), cursor: tblAgrEventsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblAgrEventsScalarFieldEnumSchema, TblAgrEventsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblAgrEventsFindFirstOrThrowArgs>;

export const tblAgrEventsFindFirstOrThrowZodSchema = z.object({ select: tblAgrEventsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tblAgrEventsIncludeObjectSchema.optional()), orderBy: z.union([tblAgrEventsOrderByWithRelationInputObjectSchema, tblAgrEventsOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblAgrEventsWhereInputObjectSchema.optional(), cursor: tblAgrEventsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblAgrEventsScalarFieldEnumSchema, TblAgrEventsScalarFieldEnumSchema.array()]).optional() }).strict();