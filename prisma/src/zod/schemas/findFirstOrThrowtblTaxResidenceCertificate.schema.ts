...
export const tblTaxResidenceCertificateFindFirstOrThrowSelectSchema: z.ZodType<Prisma.tblTaxResidenceCertificateSelect> = z.object({
...
export const tblTaxResidenceCertificateFindFirstOrThrowSelectZodSchema = z.object({
    CertID: z.boolean().optional(),
    ClientID: z.boolean().optional(),
    ValidDate: z.boolean().optional(),
    RequestDate: z.boolean().optional(),
...
export const tblTaxResidenceCertificateFindFirstOrThrowSchema: z.ZodType<Prisma.tblTaxResidenceCertificateFindFirstOrThrowArgs> = z.object({ select: tblTaxResidenceCertificateFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([tblTaxResidenceCertificateOrderByWithRelationInputObjectSchema, tblTaxResidenceCertificateOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblTaxResidenceCertificateWhereInputObjectSchema.optional(), cursor: tblTaxResidenceCertificateWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblTaxResidenceCertificateScalarFieldEnumSchema, TblTaxResidenceCertificateScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblTaxResidenceCertificateFindFirstOrThrowArgs>;

export const tblTaxResidenceCertificateFindFirstOrThrowZodSchema = z.object({ select: tblTaxResidenceCertificateFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([tblTaxResidenceCertificateOrderByWithRelationInputObjectSchema, tblTaxResidenceCertificateOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblTaxResidenceCertificateWhereInputObjectSchema.optional(), cursor: tblTaxResidenceCertificateWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblTaxResidenceCertificateScalarFieldEnumSchema, TblTaxResidenceCertificateScalarFieldEnumSchema.array()]).optional() }).strict();