...
export const tblClients_obsoleteFindManySelectSchema: z.ZodType<Prisma.tblClients_obsoleteSelect> = z.object({
...
export const tblClients_obsoleteFindManySelectZodSchema = z.object({
    CustID: z.boolean().optional(),
    RepModeID: z.boolean().optional(),
    GraalID: z.boolean().optional(),
    Commission: z.boolean().optional(),
