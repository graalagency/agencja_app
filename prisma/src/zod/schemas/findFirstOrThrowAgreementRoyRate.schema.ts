...
export const AgreementRoyRateFindFirstOrThrowSelectSchema: z.ZodType<Prisma.AgreementRoyRateSelect> = z.object({
...
export const AgreementRoyRateFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    agreementId: z.boolean().optional(),
    rightId: z.boolean().optional(),
    step: z.boolean().optional(),
...
export const AgreementRoyRateFindFirstOrThrowSchema: z.ZodType<Prisma.AgreementRoyRateFindFirstOrThrowArgs> = z.object({ select: AgreementRoyRateFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => AgreementRoyRateIncludeObjectSchema.optional()), orderBy: z.union([AgreementRoyRateOrderByWithRelationInputObjectSchema, AgreementRoyRateOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgreementRoyRateWhereInputObjectSchema.optional(), cursor: AgreementRoyRateWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgreementRoyRateScalarFieldEnumSchema, AgreementRoyRateScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AgreementRoyRateFindFirstOrThrowArgs>;

export const AgreementRoyRateFindFirstOrThrowZodSchema = z.object({ select: AgreementRoyRateFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => AgreementRoyRateIncludeObjectSchema.optional()), orderBy: z.union([AgreementRoyRateOrderByWithRelationInputObjectSchema, AgreementRoyRateOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgreementRoyRateWhereInputObjectSchema.optional(), cursor: AgreementRoyRateWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgreementRoyRateScalarFieldEnumSchema, AgreementRoyRateScalarFieldEnumSchema.array()]).optional() }).strict();