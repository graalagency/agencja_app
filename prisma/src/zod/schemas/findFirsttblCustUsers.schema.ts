...
export const tblCustUsersFindFirstSelectSchema: z.ZodType<Prisma.tblCustUsersSelect> = z.object({
...
export const tblCustUsersFindFirstSelectZodSchema = z.object({
    CustID: z.boolean().optional(),
    Login: z.boolean().optional(),
    tblCustomers: z.boolean().optional(),
    tblUsers: z.boolean().optional()
