...
export const dictXRatesFindManySelectSchema: z.ZodType<Prisma.dictXRatesSelect> = z.object({
...
export const dictXRatesFindManySelectZodSchema = z.object({
    CurrDate: z.boolean().optional(),
    CurrID: z.boolean().optional(),
    XRate: z.boolean().optional()
  }).strict();

export const dictXRatesFindManySchema: z.ZodType<Prisma.dictXRatesFindManyArgs> = z.object({ select: dictXRatesFindManySelectSchema.optional(),  orderBy: z.union([dictXRatesOrderByWithRelationInputObjectSchema, dictXRatesOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictXRatesWhereInputObjectSchema.optional(), cursor: dictXRatesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictXRatesScalarFieldEnumSchema, DictXRatesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.dictXRatesFindManyArgs>;

export const dictXRatesFindManyZodSchema = z.object({ select: dictXRatesFindManySelectSchema.optional(),  orderBy: z.union([dictXRatesOrderByWithRelationInputObjectSchema, dictXRatesOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictXRatesWhereInputObjectSchema.optional(), cursor: dictXRatesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictXRatesScalarFieldEnumSchema, DictXRatesScalarFieldEnumSchema.array()]).optional() }).strict();