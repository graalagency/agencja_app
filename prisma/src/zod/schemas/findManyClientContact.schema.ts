...
export const ClientContactFindManySelectSchema: z.ZodType<Prisma.ClientContactSelect> = z.object({
...
export const ClientContactFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    contactId: z.boolean().optional(),
    clientId: z.boolean().optional(),
    isDefault: z.boolean().optional(),
...
export const ClientContactFindManySchema: z.ZodType<Prisma.ClientContactFindManyArgs> = z.object({ select: ClientContactFindManySelectSchema.optional(), include: z.lazy(() => ClientContactIncludeObjectSchema.optional()), orderBy: z.union([ClientContactOrderByWithRelationInputObjectSchema, ClientContactOrderByWithRelationInputObjectSchema.array()]).optional(), where: ClientContactWhereInputObjectSchema.optional(), cursor: ClientContactWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ClientContactScalarFieldEnumSchema, ClientContactScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ClientContactFindManyArgs>;

export const ClientContactFindManyZodSchema = z.object({ select: ClientContactFindManySelectSchema.optional(), include: z.lazy(() => ClientContactIncludeObjectSchema.optional()), orderBy: z.union([ClientContactOrderByWithRelationInputObjectSchema, ClientContactOrderByWithRelationInputObjectSchema.array()]).optional(), where: ClientContactWhereInputObjectSchema.optional(), cursor: ClientContactWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ClientContactScalarFieldEnumSchema, ClientContactScalarFieldEnumSchema.array()]).optional() }).strict();