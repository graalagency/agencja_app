...
export const AgreementRightFindFirstOrThrowSelectSchema: z.ZodType<Prisma.AgreementRightSelect> = z.object({
...
export const AgreementRightFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    sourceId: z.boolean().optional(),
    agreementId: z.boolean().optional(),
    rightFormId: z.boolean().optional(),
...
export const AgreementRightFindFirstOrThrowSchema: z.ZodType<Prisma.AgreementRightFindFirstOrThrowArgs> = z.object({ select: AgreementRightFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => AgreementRightIncludeObjectSchema.optional()), orderBy: z.union([AgreementRightOrderByWithRelationInputObjectSchema, AgreementRightOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgreementRightWhereInputObjectSchema.optional(), cursor: AgreementRightWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgreementRightScalarFieldEnumSchema, AgreementRightScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AgreementRightFindFirstOrThrowArgs>;

export const AgreementRightFindFirstOrThrowZodSchema = z.object({ select: AgreementRightFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => AgreementRightIncludeObjectSchema.optional()), orderBy: z.union([AgreementRightOrderByWithRelationInputObjectSchema, AgreementRightOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgreementRightWhereInputObjectSchema.optional(), cursor: AgreementRightWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgreementRightScalarFieldEnumSchema, AgreementRightScalarFieldEnumSchema.array()]).optional() }).strict();