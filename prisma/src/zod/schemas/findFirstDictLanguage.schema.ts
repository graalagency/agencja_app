...
export const DictLanguageFindFirstSelectSchema: z.ZodType<Prisma.DictLanguageSelect> = z.object({
...
export const DictLanguageFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    code: z.boolean().optional(),
    description: z.boolean().optional(),
    createdAt: z.boolean().optional(),
...
export const DictLanguageFindFirstSchema: z.ZodType<Prisma.DictLanguageFindFirstArgs> = z.object({ select: DictLanguageFindFirstSelectSchema.optional(),  orderBy: z.union([DictLanguageOrderByWithRelationInputObjectSchema, DictLanguageOrderByWithRelationInputObjectSchema.array()]).optional(), where: DictLanguageWhereInputObjectSchema.optional(), cursor: DictLanguageWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictLanguageScalarFieldEnumSchema, DictLanguageScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.DictLanguageFindFirstArgs>;

export const DictLanguageFindFirstZodSchema = z.object({ select: DictLanguageFindFirstSelectSchema.optional(),  orderBy: z.union([DictLanguageOrderByWithRelationInputObjectSchema, DictLanguageOrderByWithRelationInputObjectSchema.array()]).optional(), where: DictLanguageWhereInputObjectSchema.optional(), cursor: DictLanguageWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictLanguageScalarFieldEnumSchema, DictLanguageScalarFieldEnumSchema.array()]).optional() }).strict();