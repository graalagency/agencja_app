...
export const dictCurrenciesFindFirstOrThrowSelectSchema: z.ZodType<Prisma.dictCurrenciesSelect> = z.object({
...
export const dictCurrenciesFindFirstOrThrowSelectZodSchema = z.object({
    CurrID: z.boolean().optional(),
    CurrDesc: z.boolean().optional(),
    tblAgreements: z.boolean().optional(),
    _count: z.boolean().optional()
...
export const dictCurrenciesFindFirstOrThrowSchema: z.ZodType<Prisma.dictCurrenciesFindFirstOrThrowArgs> = z.object({ select: dictCurrenciesFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => dictCurrenciesIncludeObjectSchema.optional()), orderBy: z.union([dictCurrenciesOrderByWithRelationInputObjectSchema, dictCurrenciesOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictCurrenciesWhereInputObjectSchema.optional(), cursor: dictCurrenciesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictCurrenciesScalarFieldEnumSchema, DictCurrenciesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.dictCurrenciesFindFirstOrThrowArgs>;

export const dictCurrenciesFindFirstOrThrowZodSchema = z.object({ select: dictCurrenciesFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => dictCurrenciesIncludeObjectSchema.optional()), orderBy: z.union([dictCurrenciesOrderByWithRelationInputObjectSchema, dictCurrenciesOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictCurrenciesWhereInputObjectSchema.optional(), cursor: dictCurrenciesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictCurrenciesScalarFieldEnumSchema, DictCurrenciesScalarFieldEnumSchema.array()]).optional() }).strict();