...
export const HelionLocalFindFirstOrThrowSelectSchema: z.ZodType<Prisma.HelionLocalSelect> = z.object({
...
export const HelionLocalFindFirstOrThrowSelectZodSchema = z.object({
    ISBNORG: z.boolean().optional(),
    ISBNHELION: z.boolean().optional(),
    TYTULORG: z.boolean().optional(),
    TYTULHELION: z.boolean().optional()
...
export const HelionLocalFindFirstOrThrowSchema: z.ZodType<Prisma.HelionLocalFindFirstOrThrowArgs> = z.object({ select: HelionLocalFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([HelionLocalOrderByWithRelationInputObjectSchema, HelionLocalOrderByWithRelationInputObjectSchema.array()]).optional(), where: HelionLocalWhereInputObjectSchema.optional(), cursor: HelionLocalWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([HelionLocalScalarFieldEnumSchema, HelionLocalScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.HelionLocalFindFirstOrThrowArgs>;

export const HelionLocalFindFirstOrThrowZodSchema = z.object({ select: HelionLocalFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([HelionLocalOrderByWithRelationInputObjectSchema, HelionLocalOrderByWithRelationInputObjectSchema.array()]).optional(), where: HelionLocalWhereInputObjectSchema.optional(), cursor: HelionLocalWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([HelionLocalScalarFieldEnumSchema, HelionLocalScalarFieldEnumSchema.array()]).optional() }).strict();