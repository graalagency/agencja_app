...
export const AgreementFindFirstOrThrowSelectSchema: z.ZodType<Prisma.AgreementSelect> = z.object({
...
export const AgreementFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    sourceId: z.boolean().optional(),
    publisherId: z.boolean().optional(),
    clientId: z.boolean().optional(),
...
export const AgreementFindFirstOrThrowSchema: z.ZodType<Prisma.AgreementFindFirstOrThrowArgs> = z.object({ select: AgreementFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => AgreementIncludeObjectSchema.optional()), orderBy: z.union([AgreementOrderByWithRelationInputObjectSchema, AgreementOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgreementWhereInputObjectSchema.optional(), cursor: AgreementWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgreementScalarFieldEnumSchema, AgreementScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AgreementFindFirstOrThrowArgs>;

export const AgreementFindFirstOrThrowZodSchema = z.object({ select: AgreementFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => AgreementIncludeObjectSchema.optional()), orderBy: z.union([AgreementOrderByWithRelationInputObjectSchema, AgreementOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgreementWhereInputObjectSchema.optional(), cursor: AgreementWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgreementScalarFieldEnumSchema, AgreementScalarFieldEnumSchema.array()]).optional() }).strict();