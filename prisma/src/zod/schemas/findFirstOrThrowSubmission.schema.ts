...
export const SubmissionFindFirstOrThrowSelectSchema: z.ZodType<Prisma.SubmissionSelect> = z.object({
...
export const SubmissionFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    sourceId: z.boolean().optional(),
    titleId: z.boolean().optional(),
    publisherId: z.boolean().optional(),
...
export const SubmissionFindFirstOrThrowSchema: z.ZodType<Prisma.SubmissionFindFirstOrThrowArgs> = z.object({ select: SubmissionFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => SubmissionIncludeObjectSchema.optional()), orderBy: z.union([SubmissionOrderByWithRelationInputObjectSchema, SubmissionOrderByWithRelationInputObjectSchema.array()]).optional(), where: SubmissionWhereInputObjectSchema.optional(), cursor: SubmissionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SubmissionScalarFieldEnumSchema, SubmissionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SubmissionFindFirstOrThrowArgs>;

export const SubmissionFindFirstOrThrowZodSchema = z.object({ select: SubmissionFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => SubmissionIncludeObjectSchema.optional()), orderBy: z.union([SubmissionOrderByWithRelationInputObjectSchema, SubmissionOrderByWithRelationInputObjectSchema.array()]).optional(), where: SubmissionWhereInputObjectSchema.optional(), cursor: SubmissionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SubmissionScalarFieldEnumSchema, SubmissionScalarFieldEnumSchema.array()]).optional() }).strict();