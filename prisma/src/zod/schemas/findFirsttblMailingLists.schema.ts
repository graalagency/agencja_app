...
export const tblMailingListsFindFirstSelectSchema: z.ZodType<Prisma.tblMailingListsSelect> = z.object({
...
export const tblMailingListsFindFirstSelectZodSchema = z.object({
    ClassCode: z.boolean().optional(),
    SubClassCode: z.boolean().optional(),
    CustID: z.boolean().optional(),
    dictTitMainClass: z.boolean().optional(),
