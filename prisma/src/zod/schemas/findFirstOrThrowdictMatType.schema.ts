...
export const dictMatTypeFindFirstOrThrowSelectSchema: z.ZodType<Prisma.dictMatTypeSelect> = z.object({
...
export const dictMatTypeFindFirstOrThrowSelectZodSchema = z.object({
    MatTypeID: z.boolean().optional(),
    MatTypeDesc: z.boolean().optional(),
    MatTypeDescPL: z.boolean().optional()
  }).strict();

export const dictMatTypeFindFirstOrThrowSchema: z.ZodType<Prisma.dictMatTypeFindFirstOrThrowArgs> = z.object({ select: dictMatTypeFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([dictMatTypeOrderByWithRelationInputObjectSchema, dictMatTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictMatTypeWhereInputObjectSchema.optional(), cursor: dictMatTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictMatTypeScalarFieldEnumSchema, DictMatTypeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.dictMatTypeFindFirstOrThrowArgs>;

export const dictMatTypeFindFirstOrThrowZodSchema = z.object({ select: dictMatTypeFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([dictMatTypeOrderByWithRelationInputObjectSchema, dictMatTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: dictMatTypeWhereInputObjectSchema.optional(), cursor: dictMatTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DictMatTypeScalarFieldEnumSchema, DictMatTypeScalarFieldEnumSchema.array()]).optional() }).strict();