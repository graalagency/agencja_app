...
export const tblMailingListsFindUniqueSchema: z.ZodType<Prisma.tblMailingListsFindUniqueArgs> = z.object({ select: tblMailingListsSelectObjectSchema.optional(), include: tblMailingListsIncludeObjectSchema.optional(), where: tblMailingListsWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.tblMailingListsFindUniqueArgs>;

export const tblMailingListsFindUniqueZodSchema = z.object({ select: tblMailingListsSelectObjectSchema.optional(), include: tblMailingListsIncludeObjectSchema.optional(), where: tblMailingListsWhereUniqueInputObjectSchema }).strict();