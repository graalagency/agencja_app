...
export const LanguageDictionaryFindFirstSelectSchema: z.ZodType<Prisma.LanguageDictionarySelect> = z.object({
...
export const LanguageDictionaryFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    code: z.boolean().optional(),
    description: z.boolean().optional(),
    createdAt: z.boolean().optional(),
...
export const LanguageDictionaryFindFirstSchema: z.ZodType<Prisma.LanguageDictionaryFindFirstArgs> = z.object({ select: LanguageDictionaryFindFirstSelectSchema.optional(),  orderBy: z.union([LanguageDictionaryOrderByWithRelationInputObjectSchema, LanguageDictionaryOrderByWithRelationInputObjectSchema.array()]).optional(), where: LanguageDictionaryWhereInputObjectSchema.optional(), cursor: LanguageDictionaryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LanguageDictionaryScalarFieldEnumSchema, LanguageDictionaryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.LanguageDictionaryFindFirstArgs>;

export const LanguageDictionaryFindFirstZodSchema = z.object({ select: LanguageDictionaryFindFirstSelectSchema.optional(),  orderBy: z.union([LanguageDictionaryOrderByWithRelationInputObjectSchema, LanguageDictionaryOrderByWithRelationInputObjectSchema.array()]).optional(), where: LanguageDictionaryWhereInputObjectSchema.optional(), cursor: LanguageDictionaryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LanguageDictionaryScalarFieldEnumSchema, LanguageDictionaryScalarFieldEnumSchema.array()]).optional() }).strict();